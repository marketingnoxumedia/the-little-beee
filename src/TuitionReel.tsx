...
// ---------------------------------------------------------------------------
// "The tuition trap" reel (TuitionReel) — the A/B twin of MajorReel:
// same college-value case, but where MajorReel argues "what you study matters
// more than that you studied" (earnings by major), this cut leads on the COST
// side — real, inflation-adjusted tuition is about 3x its 1980 level while real
// wages barely moved, so a summer job that once funded a year of college now
// takes years of debt; that gap became the trillions in student debt, and a
// degree is an investment whose price and return both swing hugely by field
// (borrow $30K for an $80K job vs $120K for a $40K one). Opens on a question hook
// ("Why won't a summer job cover tuition now?") with a ~1.2s post-hook pause held
// on beat 0 (127 -> 163), lands the red "Trillions / Student debt" card mid-tail,
// and closes on a question ("What is a degree worth now?"). Durations on exact
// ElevenLabs spoken-word timestamps at +6% pace. Total 1268 frames = ~42.3s.
// **Media-dense:** 16 of 19 beats carry footage, with only 2 flat-black beats
// ("It was never college or not.", "The price tripled. The payoff didn't.") plus
// the one red card; the close lands on footage. Own footage under public/tuition/
// — no asset shared with MajorReel or any other reel (skill hard rule).
// **Illustrative figures — verify before publishing:** "~3x real tuition since
// 1980", "real wages barely moved", the "trillions in student debt", and the
// $30K/$80K vs $120K/$40K ROI pairs are directional, widely-cited framing, not a
// single audited dataset. Same college-value case as MajorReel — publish only one
// college reel to a given audience.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  // beat 0 holds through the ~1.2s post-hook pause spliced after "…dents it?" (127 -> 163).
  {dur: 163, kind: 'hook', text: 'Why won\'t a summer job|cover tuition now?', kicker: 'The tuition trap', highlights: ['tuition'], size: 74, media: {src: 'tuition/p_campus.jpg', type: 'img', effect: 'in'}},
  {dur: 137, kind: 'stat', stat: {pre: 'After inflation, tuition is', value: 3, suffix: 'x', post: 'the 1980 price'}, media: {src: 'tuition/v_risingchart.mp4', type: 'video', effect: 'in'}},
  {dur: 41, kind: 'text', text: 'Pay didn\'t|triple with it.', highlights: ['triple'], size: 88, media: {src: 'tuition/p_flatline.jpg', type: 'img', effect: 'in'}},
  {dur: 75, kind: 'text', text: 'That\'s the real price.|Not sticker inflation.', highlights: ['real'], size: 72, media: {src: 'tuition/p_receipt.jpg', type: 'img', effect: 'in'}},
  {dur: 55, kind: 'text', enter: 'slideL', text: 'A summer job|once funded it.', highlights: ['once'], size: 82, media: {src: 'tuition/p_summerjob.jpg', type: 'img', effect: 'in'}},
  {dur: 54, kind: 'text', text: 'Now it takes years|of debt.', highlights: ['debt'], size: 80, media: {src: 'tuition/p_backpack.jpg', type: 'img', effect: 'in'}},
  {dur: 40, kind: 'text', text: 'Real tuition|raced up.', highlights: ['raced'], size: 86, media: {src: 'tuition/p_lecturehall.jpg', type: 'img', effect: 'in'}},
  {dur: 45, kind: 'text', text: 'Real wages|barely moved.', highlights: ['barely'], size: 86, media: {src: 'tuition/p_paystub.jpg', type: 'img', effect: 'in'}},
  {dur: 54, kind: 'text', text: 'The gap fills|with student loans.', highlights: ['loans'], size: 80, media: {src: 'tuition/p_loanform.jpg', type: 'img', effect: 'in'}},
  {dur: 70, kind: 'impact', text: 'Trillions.|Student debt.', redBg: true},
  {dur: 43, kind: 'text', enter: 'slideL', text: 'A degree is|an investment.', highlights: ['investment'], size: 84, media: {src: 'tuition/p_diploma.jpg', type: 'img', effect: 'in'}},
  {dur: 43, kind: 'text', text: 'A price,|and a return.', highlights: ['return'], size: 86, media: {src: 'tuition/p_scale.jpg', type: 'img', effect: 'in'}},
  {dur: 50, kind: 'text', text: 'Both swing|hugely by field.', highlights: ['field'], size: 84, media: {src: 'tuition/v_paths.mp4', type: 'video', effect: 'in'}},
  {dur: 71, kind: 'text', text: 'Borrow $30K,|the job pays $80K.', highlights: ['$80k'], size: 76, media: {src: 'tuition/p_success.jpg', type: 'img', effect: 'in'}},
  {dur: 64, kind: 'text', text: 'Not like $120K|for $40K.', highlights: ['$120k'], size: 80, media: {src: 'tuition/p_burden.jpg', type: 'img', effect: 'in'}},
  {dur: 53, kind: 'text', text: 'It was never|college or not.', highlights: ['never'], size: 82},
  {dur: 66, kind: 'text', enter: 'slideL', text: 'It\'s this price,|for this return.', highlights: ['price'], size: 78, media: {src: 'tuition/p_signing.jpg', type: 'img', effect: 'in'}},
  {dur: 69, kind: 'text', text: 'The price tripled.|The payoff didn\'t.', highlights: ['payoff'], size: 78},
  {dur: 75, kind: 'text', enter: 'zoom', text: 'What is a degree|worth now?', highlights: ['worth'], size: 80, media: {src: 'tuition/v_grad.mp4', type: 'video', effect: 'in'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
// NOTE: a 36-frame (~1.2s) pause is spliced after the hook question (frame 127);
// the impact sits on the 3x reveal, another on the red "trillions" card and the
// $80K ROI beat, whooshes on an early cut and the close.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 163, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 416, src: 'media/sfx_whoosh.mp3', vol: 0.35},
  {at: 664, src: 'media/sfx_impact.mp3', vol: 0.6},
  {at: 870, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 1193, src: 'media/sfx_whoosh.mp3', vol: 0.4},
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>The tuition trap</span>
      </div>
...
// ---------------------------------------------------------------------------
export const TuitionReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('tuition/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('tuition/music.mp3')}
