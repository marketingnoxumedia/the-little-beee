...
// ---------------------------------------------------------------------------
// "The never-ending payment" reel — car leasing vs buying, told through the numbers (this
// is the SAME lease-vs-buy topic as the existing LeaseReel AND PaymentReel — publish only
// one, or space them far apart). Two drivers with the same $400/month car budget end up
// thousands apart: over ten years one leases and pays every single month, the other buys,
// finances for five years, and then drives five years for free. A lease feels smart — a
// newish car, a fixed cost, nothing up front — so the payment never feels like the problem;
// but lease continuously and it never ends. Ten years in: 120 payments and you own nothing.
// Buy: about 60 payments, then the loan ends and the cost drops toward zero. Leasing rents
// access permanently — you pay for the newest model, not for something you keep. The lever
// was never which car; it's whether the payment ever stops. Unlike PaymentReel (a pure
// shape/comparison), THIS cut is numbers-driven: three count-up `stat` beats ($400/mo, 120
// payments, 60 payments). A short ~1.5s pause after the hook (house convention), eight black
// beats for the punch-lines, one red "leasing rents access, permanently" `impact` card as
// the mid-tail thesis, and a rhetorical question close on footage (a car at dusk) rather
// than the red card. Durations on exact spoken-word timestamps (ElevenLabs alignment) at
// +6% pace. Total 1690 frames = ~56.3s. `enter` adds a transition on some cuts. Every scene
// uses a distinct background sourced fresh for THIS reel (public/neverstop/) — no footage
// shared with LeaseReel, PaymentReel, or any other reel (hard rule). FLAG: illustrative —
...
const SCENES: SceneDef[] = [
  {dur: 90, kind: 'hook', text: 'Two drivers,|same car budget.', kicker: 'The never-ending payment', highlights: ['budget'], size: 86, media: {src: 'neverstop/v_hook.mp4', type: 'video', effect: 'in'}},
  ...
  {dur: 104, kind: 'text', text: 'Thousands of|dollars apart.', highlights: ['thousands'], size: 92, media: {src: 'neverstop/p_money.jpg', type: 'img', effect: 'in'}},
  {dur: 72, kind: 'stat', stat: {pre: 'EACH SPENDS', prefix: '$', value: 400, post: 'A MONTH'}, media: {src: 'neverstop/p_budget.jpg', type: 'img', effect: 'in'}},
  {dur: 39, kind: 'text', text: 'One pays every|single month.', highlights: ['every'], size: 92, media: {src: 'neverstop/p_calendar.jpg', type: 'img', effect: 'in'}},
  {dur: 56, kind: 'text', text: 'The other stops|halfway through.', highlights: ['stops'], size: 90},
  {dur: 99, kind: 'text', enter: 'slideL', text: 'A lease|feels smart.', highlights: ['smart'], size: 100, media: {src: 'neverstop/p_newcar.jpg', type: 'img', effect: 'in'}},
  {dur: 32, kind: 'text', text: 'Nothing huge|up front.', highlights: ['front'], size: 94, media: {src: 'neverstop/p_leasedeal.jpg', type: 'img', effect: 'in'}},
  {dur: 123, kind: 'text', text: 'Feels normal —|never the problem.', highlights: ['normal'], size: 88},
  {dur: 77, kind: 'text', text: 'But the payment|never ends.', highlights: ['never'], size: 96},
  {dur: 42, kind: 'stat', stat: {pre: 'TEN YEARS IN', value: 120, post: 'PAYMENTS'}, media: {src: 'neverstop/p_120.jpg', type: 'img', effect: 'in'}},
  {dur: 104, kind: 'text', enter: 'slideL', text: 'And you own|nothing.', highlights: ['nothing'], size: 100, media: {src: 'neverstop/p_ownnothing.jpg', type: 'img', effect: 'in'}},
  {dur: 62, kind: 'stat', stat: {pre: 'BUY INSTEAD', value: 60, post: 'PAYMENTS'}},
  {dur: 48, kind: 'text', enter: 'slideL', text: 'Then drive five|years for free.', highlights: ['free'], size: 88, media: {src: 'neverstop/v_road.mp4', type: 'video', effect: 'in'}},
  {dur: 39, kind: 'text', text: 'Not one lucky|example.', highlights: ['lucky'], size: 92},
  {dur: 107, kind: 'text', text: 'It\'s the shape|of the deal.', highlights: ['shape'], size: 92, media: {src: 'neverstop/v_lot.mp4', type: 'video', effect: 'in'}},
  {dur: 80, kind: 'text', text: 'A loan|ends.', highlights: ['ends'], size: 104, media: {src: 'neverstop/p_loanend.jpg', type: 'img', effect: 'in'}},
  {dur: 46, kind: 'text', text: 'The cost drops|toward zero.', highlights: ['zero'], size: 92},
  {dur: 80, kind: 'text', enter: 'slideL', text: 'The leaser|keeps paying.', highlights: ['keeps'], size: 92, media: {src: 'neverstop/p_payment.jpg', type: 'img', effect: 'in'}},
  {dur: 97, kind: 'impact', text: 'Leasing rents access.|Permanently.', redBg: true},
  {dur: 46, kind: 'text', text: 'Not something|you keep.', highlights: ['keep'], size: 92, media: {src: 'neverstop/p_keys.jpg', type: 'img', effect: 'in'}},
  {dur: 48, kind: 'text', text: 'The lever was never|which car.', highlights: ['never'], size: 88},
  {dur: 49, kind: 'text', text: 'It\'s whether the|payment stops.', highlights: ['stops'], size: 90},
  {dur: 81, kind: 'text', enter: 'slideL', text: 'Same car,|same budget.', highlights: ['budget'], size: 98, media: {src: 'neverstop/p_free.jpg', type: 'img', effect: 'in'}},
  {dur: 69, kind: 'text', enter: 'zoom', text: 'What was it|really buying?', highlights: ['buying?'], size: 90, media: {src: 'neverstop/v_close.mp4', type: 'video', effect: 'in'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
// NOTE: a 45-frame (~1.5s) pause is spliced after the hook (at frame ~131), so cues at
// or after the reveal (frame 194) are already on the post-pause timeline.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 194, src: 'media/sfx_whoosh.mp3', vol: 0.4},   // reveal after the pause ($400 stat)
  {at: 615, src: 'media/sfx_whoosh.mp3', vol: 0.4},   // "the payment never ends" punch
  {at: 692, src: 'media/sfx_impact.mp3', vol: 0.5},   // 120 payments stat
  {at: 838, src: 'media/sfx_impact.mp3', vol: 0.5},   // 60 payments stat
  {at: 1094, src: 'media/sfx_impact.mp3', vol: 0.45}, // "a loan ends"
  {at: 1300, src: 'media/sfx_impact.mp3', vol: 0.72}, // red thesis card
  {at: 1621, src: 'media/sfx_whoosh.mp3', vol: 0.4},  // close
];
...
// ---------------------------------------------------------------------------
export const NeverstopReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('neverstop/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('neverstop/music.mp3')}
