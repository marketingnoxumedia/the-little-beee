...
// ---------------------------------------------------------------------------
// "Hours aren't output" reel — the hours-worked vs productivity myth. Effort is
...
const SCENES: SceneDef[] = [
  {dur: 125, kind: 'hook', text: 'More hours,|more output?', kicker: 'Hours aren\'t output', highlights: ['hours'], size: 92, media: {src: 'output/v_clock.mp4', type: 'video', effect: 'in'}},
  {dur: 81, kind: 'text', enter: 'slideR', text: 'Then why work less,|make more?', highlights: ['more'], size: 88, media: {src: 'output/p_world.jpg', type: 'img', effect: 'in'}},
  {dur: 42, kind: 'text', text: 'The belief is|easy to hold.', highlights: ['belief'], size: 90, media: {src: 'output/p_think.jpg', type: 'img', effect: 'in'}},
  {dur: 61, kind: 'text', text: 'Effort is what|you control.', highlights: ['effort'], size: 90, media: {src: 'output/p_effort.jpg', type: 'img', effect: 'in'}},
  {dur: 94, kind: 'text', enter: 'slideL', text: 'Busyness reads|as productivity.', highlights: ['busyness'], size: 86, media: {src: 'output/p_busy.jpg', type: 'img', effect: 'in'}},
  {dur: 29, kind: 'text', text: 'Hours are easy|to count.', highlights: ['count'], size: 90, media: {src: 'output/p_clockcount.jpg', type: 'img', effect: 'in'}},
  {dur: 60, kind: 'text', text: 'Value|isn\'t.', highlights: ['value'], size: 108},
  {dur: 117, kind: 'text', text: 'Longer hours|don\'t track output.', highlights: ['longer'], size: 88, media: {src: 'output/p_flatchart.jpg', type: 'img', effect: 'in'}},
  {dur: 134, kind: 'text', enter: 'slideL', text: 'Fewer hours.|More per hour.', highlights: ['fewer'], size: 90, media: {src: 'output/p_efficient.jpg', type: 'img', effect: 'in'}},
  {dur: 78, kind: 'text', text: 'Past a point,|fatigue hits.', highlights: ['fatigue'], size: 90, media: {src: 'output/p_tired.jpg', type: 'img', effect: 'in'}},
  {dur: 42, kind: 'text', text: 'Diminishing|returns.', highlights: ['diminishing'], size: 92, media: {src: 'output/p_curve.jpg', type: 'img', effect: 'in'}},
  {dur: 112, kind: 'text', text: 'A rested worker|out-produces.', highlights: ['rested'], size: 90, media: {src: 'output/p_rested.jpg', type: 'img', effect: 'in'}},
  {dur: 53, kind: 'text', text: 'Same task.|Less time.', highlights: ['less'], size: 100},
  {dur: 29, kind: 'text', text: 'Capped by focus|and energy.', highlights: ['energy'], size: 88, media: {src: 'output/p_focus.jpg', type: 'img', effect: 'in'}},
  {dur: 73, kind: 'text', text: 'Not by|the clock.', highlights: ['clock'], size: 100, media: {src: 'output/p_clock2.jpg', type: 'img', effect: 'in'}},
  {dur: 78, kind: 'text', enter: 'slideL', text: 'Hours as the goal|confuses it.', highlights: ['confuses'], size: 88, media: {src: 'output/p_maze.jpg', type: 'img', effect: 'in'}},
  {dur: 56, kind: 'text', text: 'It was never|how long.', highlights: ['long'], size: 92, media: {src: 'output/p_hourglass.jpg', type: 'img', effect: 'in'}},
  {dur: 53, kind: 'text', text: "It's the value|per hour.", highlights: ['value'], size: 92, media: {src: 'output/p_gem.jpg', type: 'img', effect: 'in'}},
  {dur: 67, kind: 'impact', text: 'The lever was never|the length of the day.', redBg: true},
  {dur: 64, kind: 'text', enter: 'slideL', text: "It's the value|inside each hour.", highlights: ['value'], size: 90, media: {src: 'output/v_craft.mp4', type: 'video', effect: 'in'}},
  {dur: 105, kind: 'text', text: 'The longest hours|don\'t build the most.', highlights: ['longest'], size: 86, media: {src: 'output/p_late.jpg', type: 'img', effect: 'in'}},
  {dur: 37, kind: 'text', enter: 'zoom', text: 'What was it|all buying?', highlights: ['all'], size: 92, media: {src: 'output/v_close.mp4', type: 'video', effect: 'in'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 125, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 432, src: 'media/sfx_impact.mp3', vol: 0.45},
  {at: 609, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 975, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 1384, src: 'media/sfx_impact.mp3', vol: 0.72},
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>Hours aren't output</span>
      </div>
...
// ---------------------------------------------------------------------------
export const OutputReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('output/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('output/music.mp3')}
