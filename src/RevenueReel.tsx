...
// ---------------------------------------------------------------------------
// "Not all revenue is good" reel — some customers cost more to serve (support,
// returns, discounts, rework) than they ever pay, but revenue is visible and cost
// to serve is scattered thin, so it never lands on a line anyone is judged by.
// Measure profit per customer instead of revenue and a slice of accounts are losing
// money; shed them — raise prices, drop the money-losers — and revenue falls while
// margin rises. The accounts that left were the drag; the ones that stayed paid the
// bills. Not all revenue is good revenue; busy and profitable aren't the same thing.
// Durations placed on exact spoken-word timestamps (ElevenLabs alignment) at +6%
// pace. Total 1725 frames = ~57.5s. `enter` adds a transition on some cuts. Every
// scene uses a distinct background sourced fresh for this reel — no footage is shared
// with any other reel (see the skill's hard rule). No count-up stat (it's a
// concept, not a figure); two black beats, a red "not all revenue is good revenue"
// card near the tail, and a close on footage rather than the red card. Illustrative
// business principle — no specific company or numbers.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 88, kind: 'hook', text: 'Fire your|paying customers?', kicker: 'Not all revenue is good', highlights: ['fire'], size: 90, media: {src: 'revenue/v_hook.mp4', type: 'video', effect: 'in'}},
  {dur: 91, kind: 'text', enter: 'slideR', text: 'And make more|when they leave?', highlights: ['more'], size: 88, media: {src: 'revenue/p_exit.jpg', type: 'img', effect: 'in'}},
  {dur: 32, kind: 'text', text: 'Every customer|has a cost.', highlights: ['cost'], size: 92, media: {src: 'revenue/p_customer.jpg', type: 'img', effect: 'in'}},
  {dur: 110, kind: 'text', text: 'Support. Returns.|Discounts.', highlights: ['discounts'], size: 90, media: {src: 'revenue/p_support.jpg', type: 'img', effect: 'in'}},
  {dur: 90, kind: 'text', text: 'Sometimes it exceeds|what they pay.', highlights: ['exceeds'], size: 86, media: {src: 'revenue/p_invoice.jpg', type: 'img', effect: 'in'}},
  {dur: 82, kind: 'text', text: 'The instinct runs|the other way.', highlights: ['instinct'], size: 88},
  {dur: 97, kind: 'text', enter: 'slideL', text: 'Every account|feels like a win.', highlights: ['win'], size: 88, media: {src: 'revenue/p_win.jpg', type: 'img', effect: 'in'}},
  {dur: 42, kind: 'text', text: 'Dropping one looks|like self-harm.', highlights: ['dropping'], size: 86, media: {src: 'revenue/p_cut.jpg', type: 'img', effect: 'in'}},
  {dur: 95, kind: 'text', text: 'But the cost|hides everywhere.', highlights: ['hides'], size: 88, media: {src: 'revenue/p_scattered.jpg', type: 'img', effect: 'in'}},
  {dur: 102, kind: 'text', text: 'Returns. Discounts.|Rework.', highlights: ['rework'], size: 90, media: {src: 'revenue/p_returns.jpg', type: 'img', effect: 'in'}},
  {dur: 72, kind: 'text', text: "Never on the line|you're judged by.", highlights: ['line'], size: 86, media: {src: 'revenue/p_ledger.jpg', type: 'img', effect: 'in'}},
  {dur: 122, kind: 'text', enter: 'slideL', text: 'Measure profit|per customer.', highlights: ['profit'], size: 92, media: {src: 'revenue/p_calc.jpg', type: 'img', effect: 'in'}},
  {dur: 31, kind: 'text', text: 'Some accounts|lose money.', highlights: ['lose'], size: 92, media: {src: 'revenue/p_red.jpg', type: 'img', effect: 'in'}},
  {dur: 31, kind: 'text', text: 'So the company|sheds them.', highlights: ['sheds'], size: 92, media: {src: 'revenue/p_shed.jpg', type: 'img', effect: 'in'}},
  {dur: 111, kind: 'text', text: 'Raise prices.|Drop the losers.', highlights: ['drop'], size: 90, media: {src: 'revenue/p_pricetag.jpg', type: 'img', effect: 'in'}},
  {dur: 55, kind: 'text', text: 'Revenue|falls.', highlights: ['falls'], size: 104, media: {src: 'revenue/p_down.jpg', type: 'img', effect: 'in'}},
  {dur: 82, kind: 'text', enter: 'slideL', text: 'Lower revenue.|Higher profit.', highlights: ['profit'], size: 90, media: {src: 'revenue/v_charts.mp4', type: 'video', effect: 'in'}},
  {dur: 57, kind: 'text', text: 'The ones that left|were the drag.', highlights: ['drag'], size: 88, media: {src: 'revenue/p_anchor.jpg', type: 'img', effect: 'in'}},
  {dur: 27, kind: 'text', text: 'The ones that stayed|paid the bills.', highlights: ['bills'], size: 86, media: {src: 'revenue/p_bills.jpg', type: 'img', effect: 'in'}},
  {dur: 57, kind: 'impact', text: 'Not all revenue|is good revenue.', redBg: true},
  {dur: 76, kind: 'text', text: 'Busy and profitable|aren\'t the same.', highlights: ['busy'], size: 86, media: {src: 'revenue/p_busy.jpg', type: 'img', effect: 'in'}},
  {dur: 82, kind: 'text', enter: 'slideL', text: 'Revenue drops.|Profit climbs.', highlights: ['climbs'], size: 90, media: {src: 'revenue/p_climb.jpg', type: 'img', effect: 'in'}},
  {dur: 51, kind: 'text', text: 'Which customers|walked out?', highlights: ['walked'], size: 92},
  {dur: 42, kind: 'text', enter: 'zoom', text: 'The ones never|paying their way.', highlights: ['never'], size: 92, media: {src: 'revenue/v_close.mp4', type: 'video', effect: 'in'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 88, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 411, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 901, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 1196, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 1251, src: 'media/sfx_chaching.mp3', vol: 0.5},
  {at: 1474, src: 'media/sfx_impact.mp3', vol: 0.72},
  {at: 1683, src: 'media/sfx_impact.mp3', vol: 0.5},
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>Not all revenue is good</span>
      </div>
...
// ---------------------------------------------------------------------------
export const RevenueReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('revenue/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('revenue/music.mp3')}
