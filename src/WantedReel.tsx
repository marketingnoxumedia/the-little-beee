...
// ---------------------------------------------------------------------------
// "Why startups fail" reel (WantedReel) — the MYTH-BUST A/B twin of MonthsReel:
// same case (most startups don't die of a bad idea — the top two causes are no
// market need ~35% and running out of cash ~38%; being beaten by a rival ranks
// lower; survival is confirming real demand and protecting the runway), but this
// cut leads on the hindsight myth ("the story becomes: the idea was obviously
// bad — clean, simple, and mostly wrong") before correcting it, opens on a
// question hook ("Want to know why most startups fail?") with a ~1.2s post-hook
// pause held on beat 0 (51 -> 87), lands the red thesis card "Rarely / the idea"
// mid-tail, and closes on a question ("What were those failed founders really
// missing?"). Durations on exact ElevenLabs spoken-word timestamps at +6% pace.
// Total 1423 frames = ~47.4s. **Media-dense:** 20 of 23 beats carry footage,
// with only 2 flat-black beats ("Clean, simple, and mostly wrong.",
// "Undramatic. Both of them.") plus the one red card; the close lands on footage.
// Own footage under public/wanted/ — no asset shared with MonthsReel or any
// other reel (skill hard rule). **Illustrative figures — verify before
// publishing:** the ~35% no-market-need / ~38% out-of-cash split reflects widely
// cited startup-postmortem studies, not a single audited dataset. Same
// why-startups-fail case as MonthsReel — publish only one of the two to a given
// audience.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  // beat 0 holds through the ~1.2s post-hook pause spliced after "…fail?" (51 -> 87).
  {dur: 87, kind: 'hook', text: 'Want to know why|most startups fail?', kicker: 'Why startups fail', highlights: ['fail?'], size: 78, media: {src: 'wanted/p_founder.jpg', type: 'img', effect: 'in'}},
  {dur: 43, kind: 'text', text: 'It\'s almost never|the idea.', highlights: ['idea'], size: 84, media: {src: 'wanted/p_lightbulb.jpg', type: 'img', effect: 'in'}},
  {dur: 62, kind: 'stat', stat: {pre: 'Run out of cash', value: 38, suffix: '%'}, media: {src: 'wanted/p_emptywallet.jpg', type: 'img', effect: 'in'}},
  {dur: 85, kind: 'stat', stat: {pre: 'Build something nobody wanted', value: 35, suffix: '%'}, media: {src: 'wanted/p_emptyshelf.jpg', type: 'img', effect: 'in'}},
  {dur: 69, kind: 'text', enter: 'slideL', text: 'Hindsight|rewrites it.', highlights: ['hindsight'], size: 86, media: {src: 'wanted/p_rearview.jpg', type: 'img', effect: 'in'}},
  {dur: 65, kind: 'text', text: 'The story becomes:|the idea was bad.', highlights: ['bad'], size: 74, media: {src: 'wanted/p_headline.jpg', type: 'img', effect: 'in'}},
  {dur: 57, kind: 'text', text: 'Clean, simple,|and mostly wrong.', highlights: ['wrong'], size: 80},
  {dur: 81, kind: 'text', text: 'Studied up close:|not bad products.', highlights: ['products'], size: 74, media: {src: 'wanted/p_microscope.jpg', type: 'img', effect: 'in'}},
  {dur: 27, kind: 'text', text: 'No market|need.', highlights: ['need'], size: 92, media: {src: 'wanted/p_nocustomers.jpg', type: 'img', effect: 'in'}},
  {dur: 25, kind: 'text', text: 'Out of|cash.', highlights: ['cash'], size: 92, media: {src: 'wanted/p_coins.jpg', type: 'img', effect: 'in'}},
  {dur: 33, kind: 'text', text: 'Undramatic.|Both of them.', highlights: ['undramatic'], size: 82},
  {dur: 76, kind: 'text', enter: 'slideL', text: 'Beaten by a rival|ranks lower.', highlights: ['lower'], size: 76, media: {src: 'wanted/p_rival.jpg', type: 'img', effect: 'in'}},
  {dur: 63, kind: 'text', text: 'No dramatic|battle.', highlights: ['battle'], size: 84, media: {src: 'wanted/p_calm.jpg', type: 'img', effect: 'in'}},
  {dur: 27, kind: 'text', text: 'Not wanted|enough.', highlights: ['enough'], size: 88, media: {src: 'wanted/p_unsoldstock.jpg', type: 'img', effect: 'in'}},
  {dur: 82, kind: 'text', text: 'Or hit zero|before they learn.', highlights: ['zero'], size: 78, media: {src: 'wanted/p_zerobank.jpg', type: 'img', effect: 'in'}},
  {dur: 37, kind: 'impact', text: 'Rarely.|The idea.', redBg: true},
  {dur: 91, kind: 'text', enter: 'slideL', text: 'Survival isn\'t|the cleverest idea.', highlights: ['cleverest'], size: 74, media: {src: 'wanted/p_brainstorm.jpg', type: 'img', effect: 'in'}},
  {dur: 52, kind: 'text', text: 'Confirm|real demand.', highlights: ['demand'], size: 84, media: {src: 'wanted/v_market.mp4', type: 'video', effect: 'in'}},
  {dur: 81, kind: 'text', text: 'Protect the runway|that buys time.', highlights: ['runway'], size: 76, media: {src: 'wanted/p_runway.jpg', type: 'img', effect: 'in'}},
  {dur: 32, kind: 'text', text: 'Ideas|are cheap.', highlights: ['cheap'], size: 90, media: {src: 'wanted/p_stickynotes.jpg', type: 'img', effect: 'in'}},
  {dur: 72, kind: 'text', text: 'Proven demand.|Cash to keep learning.', highlights: ['proven'], size: 74, media: {src: 'wanted/p_teamwork.jpg', type: 'img', effect: 'in'}},
  {dur: 92, kind: 'text', enter: 'slideL', text: 'That\'s the|whole game.', highlights: ['game'], size: 84, media: {src: 'wanted/p_growth.jpg', type: 'img', effect: 'in'}},
  {dur: 84, kind: 'text', enter: 'zoom', text: 'What were those founders|really missing?', highlights: ['missing?'], size: 74, media: {src: 'wanted/v_reflect.mp4', type: 'video', effect: 'in'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
// NOTE: a 36-frame (~1.2s) pause is spliced after the hook question (frame 87);
// the whoosh sits on the post-pause reveal, impacts on the two stat reveals and
// the red thesis card.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 87, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 130, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 192, src: 'media/sfx_impact.mp3', vol: 0.55},
  {at: 882, src: 'media/sfx_impact.mp3', vol: 0.6},
  {at: 1339, src: 'media/sfx_whoosh.mp3', vol: 0.4},
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>Why startups fail</span>
      </div>
...
// ---------------------------------------------------------------------------
export const WantedReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('wanted/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('wanted/music.mp3')}
