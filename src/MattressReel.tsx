...
// ---------------------------------------------------------------------------
// "The safe illusion" reel (MattressReel) — inflation quietly eats idle cash. You think cash is
// the safe place to keep your money? $10,000 hidden under a mattress in 1980, untouched, buys
// only about $2,500 worth today — nobody took it, prices did. Cash feels solid (the number never
// drops), so it feels like the no-risk thing, but since 1980 the price level roughly quadrupled:
// a 1980 dollar buys ~25 cents now, and what cost $100 then costs ~$390 today. It isn't a
// one-year blip — it compounds every year in the background; that same $10K left in the market
// would be worth far more, even after inflation, and the loss came from doing nothing at all.
// Cash isn't neutral: held long enough it slowly loses, and the safe-feeling choice is the one
// quietly shrinking — standing still doesn't hold your place, it moves you backwards. Numbers-
// driven: three count-up `stat` beats ($2,500 / 25¢ / $390). A short ~1.5s pause after the hook
// (house convention), black beats for the punch-lines, one red "it moves you backwards" `impact`
// card as the mid-tail thesis, and a rhetorical question close ("what is cash protecting you
// from?") on footage rather than the red card. Durations on exact spoken-word timestamps
// (ElevenLabs alignment) at +6% pace. Total 1622 frames = ~54.1s. `enter` adds a transition on
// some cuts. Every scene uses a distinct background sourced fresh for THIS reel (public/mattress/)
// — no footage shared with any other reel (hard rule). NOTE: this is the SAME topic as the
// existing InflationReel ("The inflation tax") — publish only one, or run this as a deliberate
// A/B / refreshed take. FLAG: real figures — the "US price level ~4x since 1980 / a 1980 dollar
// buys ~25¢ / $100 → ~$390" numbers are broadly correct CPI-based approximations but drift with
// the exact base month and year; verify against current CPI before publishing. Imagery is
// generic (no store/retailer brands, no legible tickers, US currency only).
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 129, kind: 'hook', text: 'Cash is the|safe place?', kicker: 'The safe illusion', highlights: ['safe'], size: 92, media: {src: 'mattress/v_hook.mp4', type: 'video', effect: 'in'}},
  // Short ~1.5s pause after the hook (house convention): 45 frames of silence are spliced
  // into the VO right after "...keep your money?", and this beat holds through it.
  {dur: 116, kind: 'text', text: 'Ten grand, hidden|since 1980.', highlights: ['1980'], size: 90, media: {src: 'mattress/p_mattress.jpg', type: 'img', effect: 'in'}},
  {dur: 65, kind: 'stat', stat: {pre: 'TODAY IT BUYS', prefix: '$', value: 2500, post: 'WORTH'}, media: {src: 'mattress/p_vintage.jpg', type: 'img', effect: 'in'}},
  {dur: 69, kind: 'text', text: 'Nobody took it.|Prices did.', highlights: ['prices'], size: 90},
  {dur: 58, kind: 'text', text: 'The number|never drops.', highlights: ['never'], size: 92, media: {src: 'mattress/p_cash.jpg', type: 'img', effect: 'in'}},
  {dur: 77, kind: 'text', enter: 'slideL', text: 'Feels like|no risk.', highlights: ['risk'], size: 94, media: {src: 'mattress/p_vault.jpg', type: 'img', effect: 'in'}},
  {dur: 85, kind: 'text', text: 'Prices took|three quarters.', highlights: ['quarters'], size: 88, media: {src: 'mattress/v_prices.mp4', type: 'video', effect: 'in'}},
  {dur: 84, kind: 'text', text: 'The price level|quadrupled.', highlights: ['quadrupled'], size: 90},
  {dur: 134, kind: 'stat', stat: {pre: 'A 1980 DOLLAR BUYS', value: 25, suffix: '¢', post: 'NOW'}, media: {src: 'mattress/p_coins.jpg', type: 'img', effect: 'in'}},
  {dur: 66, kind: 'stat', stat: {pre: '$100 THEN COSTS', prefix: '$', value: 390, post: 'NOW'}, media: {src: 'mattress/p_grocery.jpg', type: 'img', effect: 'in'}},
  {dur: 25, kind: 'text', text: 'Not a one-year|blip.', highlights: ['blip'], size: 96},
  {dur: 116, kind: 'text', enter: 'slideL', text: 'It compounds,|every year.', highlights: ['compounds'], size: 90, media: {src: 'mattress/p_clock.jpg', type: 'img', effect: 'in'}},
  {dur: 73, kind: 'text', text: 'That ten grand|in the market.', highlights: ['market'], size: 88, media: {src: 'mattress/v_market.mp4', type: 'video', effect: 'in'}},
  {dur: 60, kind: 'text', text: 'Far more —|even after inflation.', highlights: ['inflation'], size: 84},
  {dur: 54, kind: 'text', text: 'The loss was|doing nothing.', highlights: ['nothing'], size: 88},
  {dur: 49, kind: 'text', text: 'Cash isn\'t|neutral.', highlights: ['neutral'], size: 94, media: {src: 'mattress/p_dust.jpg', type: 'img', effect: 'in'}},
  {dur: 38, kind: 'text', text: 'Held long enough,|it loses.', highlights: ['loses'], size: 90},
  {dur: 77, kind: 'text', enter: 'slideL', text: 'The safe choice|is shrinking.', highlights: ['shrinking'], size: 90},
  {dur: 90, kind: 'impact', text: 'It moves you|backwards.', redBg: true},
  {dur: 90, kind: 'text', text: 'The safest money,|losing value.', highlights: ['losing'], size: 88},
  {dur: 67, kind: 'text', enter: 'zoom', text: 'What is cash|protecting you from?', highlights: ['protecting'], size: 84, media: {src: 'mattress/v_close.mp4', type: 'video', effect: 'in'}},
];
...
const SFX: SfxCue[] = [
  {at: 129, src: 'media/sfx_whoosh.mp3', vol: 0.4},   // reveal after the pause
  {at: 245, src: 'media/sfx_impact.mp3', vol: 0.5},   // $2,500 stat
  {at: 683, src: 'media/sfx_impact.mp3', vol: 0.5},   // 25¢ stat
  {at: 817, src: 'media/sfx_impact.mp3', vol: 0.5},   // $390 stat
  {at: 1375, src: 'media/sfx_impact.mp3', vol: 0.72}, // red thesis card
  {at: 1555, src: 'media/sfx_whoosh.mp3', vol: 0.4},  // close
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>The safe illusion</span>
      </div>
...
// ---------------------------------------------------------------------------
export const MattressReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('mattress/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('mattress/music.mp3')}
