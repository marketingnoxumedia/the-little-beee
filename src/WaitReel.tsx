...
const SCENES: SceneDef[] = [
  ...
  {dur: 70, kind: 'text', text: 'worth more than|the money itself?', highlights: ['money'], size: 82, media: {src: 'wait/v_stack.mp4', type: 'video', effect: 'in'}},
  ...
  {dur: 43, kind: 'text', enter: 'slideR', text: 'Only the start|date changes.', highlights: ['start'], size: 86, media: {src: 'wait/p_paths.jpg', type: 'img', effect: 'in'}},
  ...
  {dur: 58, kind: 'text', text: 'You pay in|$60K less—', highlights: ['$60k'], size: 88, media: {src: 'wait/p_fewcash.jpg', type: 'img', effect: 'in'}},
  ...
  {dur: 33, kind: 'text', text: 'Compounding pays|on past gains.', highlights: ['compounding'], size: 82, media: {src: 'wait/v_grow.mp4', type: 'video', effect: 'in'}},
  ...
  {dur: 44, kind: 'text', text: 'Not a quarter|of the outcome.', highlights: ['quarter'], size: 84, media: {src: 'wait/p_portion.jpg', type: 'img', effect: 'in'}},
  {dur: 47, kind: 'impact', text: "It's closer|to half.", redBg: true},
  {dur: 53, kind: 'text', enter: 'slideL', text: 'Time did more work|than the money.', highlights: ['time'], size: 84, media: {src: 'wait/p_calendar.jpg', type: 'img', effect: 'in'}},
  {dur: 25, kind: 'text', text: "The gap wasn't|effort.", highlights: ['effort'], size: 92, media: {src: 'wait/p_rest.jpg', type: 'img', effect: 'in'}},
  {dur: 33, kind: 'text', enter: 'zoom', text: 'It was|years.', highlights: ['years'], size: 100, media: {src: 'wait/p_years.jpg', type: 'img', effect: 'in'}},
  {dur: 71, kind: 'text', enter: 'slideL', text: 'If a decade beats|the dollars—', highlights: ['decade'], size: 84, media: {src: 'wait/v_timemoney.mp4', type: 'video', effect: 'in'}},
