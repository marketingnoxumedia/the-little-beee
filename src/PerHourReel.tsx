...
// ---------------------------------------------------------------------------
// "The productivity gap" reel (data-driven take on hours-worked vs output-per-hour,
// after HoursReel / OutputReel / GrindReel — this one leads with concrete numbers).
// Germany's average worker puts in ~1,343 hours a year, Mexico's ~2,207 — a gap of
// about 864 hours, roughly a hundred extra eight-hour days — yet output per hour runs
// the other way. Across ~40 developed economies the pattern holds: the more a country
// works on average, the less it tends to make per hour (illustratively ~$10 less
// output per hour for every extra 100 annual hours). Hours measure effort, not output;
// past a point more time in the chair adds fatigue, not value. The lever was never the
// length of the day — it's what gets made inside each hour. Five count-up stats
// (1,343 / 2,207 / 864 / 40 / $10), one black beat ("Value isn't"), one red "the lever
// was never the length of the day" card near the tail, and a close on footage (a
// rhetorical question) rather than the red card. Durations placed on exact spoken-word
// timestamps (ElevenLabs alignment) at +6% pace. Total 1657 frames = ~55.2s. `enter`
// adds a transition on some cuts. Every scene uses a distinct background sourced fresh
// for this reel — no footage is shared with any other reel (see the skill's hard rule).
...
// and labelled on the stats only.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 51, kind: 'hook', text: 'Germany works|1,343 hours a year.', kicker: 'The productivity gap', highlights: ['1343'], size: 80, media: {src: 'perhour/v_hook.mp4', type: 'video', effect: 'in'}},
  {dur: 109, kind: 'stat', stat: {pre: 'Germany, per worker', value: 1343, post: 'Hours a year'}, media: {src: 'perhour/p_clock.jpg', type: 'img', effect: 'in'}},
  {dur: 69, kind: 'stat', stat: {pre: 'Mexico, per worker', value: 2207, post: 'Hours a year'}, media: {src: 'perhour/p_late.jpg', type: 'img', effect: 'in'}},
  {dur: 68, kind: 'text', enter: 'slideL', text: 'So why produce more|in every hour?', highlights: ['more'], size: 86, media: {src: 'perhour/v_produce.mp4', type: 'video', effect: 'in'}},
  {dur: 56, kind: 'text', text: 'Effort is the part|you control.', highlights: ['effort'], size: 90, media: {src: 'perhour/p_focus.jpg', type: 'img', effect: 'in'}},
  {dur: 75, kind: 'text', enter: 'slideL', text: 'Looking busy reads|as productive.', highlights: ['busy'], size: 86, media: {src: 'perhour/p_busy.jpg', type: 'img', effect: 'in'}},
  {dur: 82, kind: 'text', text: 'Hours are easy to count.|Value isn\'t.', highlights: ['value'], size: 90},
  {dur: 55, kind: 'stat', stat: {pre: 'The gap', value: 864, post: 'Hours a year'}, media: {src: 'perhour/p_calendar.jpg', type: 'img', effect: 'in'}},
  {dur: 121, kind: 'text', text: 'Roughly 100 extra|eight-hour days.', highlights: ['100'], size: 88, media: {src: 'perhour/p_planner.jpg', type: 'img', effect: 'in'}},
  {dur: 102, kind: 'text', enter: 'slideL', text: 'A hundred more days,|less per hour.', highlights: ['less'], size: 88, media: {src: 'perhour/v_commute.mp4', type: 'video', effect: 'in'}},
  {dur: 59, kind: 'text', text: 'Not two countries|cherry-picked.', highlights: ['cherry-picked'], size: 88, media: {src: 'perhour/p_data.jpg', type: 'img', effect: 'in'}},
  {dur: 62, kind: 'stat', stat: {pre: 'Line them up', value: 40, post: 'Developed economies'}, media: {src: 'perhour/p_charts.jpg', type: 'img', effect: 'in'}},
  {dur: 81, kind: 'text', enter: 'slideL', text: 'And the pattern|holds tight.', highlights: ['pattern'], size: 90, media: {src: 'perhour/v_trend.mp4', type: 'video', effect: 'in'}},
  {dur: 129, kind: 'text', text: 'More hours worked,|less made per hour.', highlights: ['less'], size: 86, media: {src: 'perhour/p_decline.jpg', type: 'img', effect: 'in'}},
  {dur: 65, kind: 'stat', stat: {prefix: '$', pre: 'Every extra 100 hours', value: 10, post: 'Less output per hour'}, media: {src: 'perhour/p_money.jpg', type: 'img', effect: 'in'}},
  {dur: 84, kind: 'text', enter: 'slideL', text: 'Hours measure effort,|not output.', highlights: ['effort'], size: 88, media: {src: 'perhour/v_treadmill.mp4', type: 'video', effect: 'in'}},
  {dur: 96, kind: 'text', text: 'More time in the chair|adds fatigue.', highlights: ['fatigue'], size: 86, media: {src: 'perhour/p_tired.jpg', type: 'img', effect: 'in'}},
  {dur: 67, kind: 'impact', text: 'The lever was never|the length of the day.', redBg: true},
  {dur: 94, kind: 'text', enter: 'slideL', text: 'It\'s what gets made|inside each hour.', highlights: ['made'], size: 88, media: {src: 'perhour/v_craft.mp4', type: 'video', effect: 'in'}},
  {dur: 67, kind: 'text', text: 'The hardest workers|make the least.', highlights: ['least'], size: 88, media: {src: 'perhour/p_overwork.jpg', type: 'img', effect: 'in'}},
  {dur: 65, kind: 'text', enter: 'zoom', text: 'What were those|extra days buying?', highlights: ['extra'], size: 88, media: {src: 'perhour/v_close.mp4', type: 'video', effect: 'in'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 51, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 160, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 428, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 510, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 847, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 1119, src: 'media/sfx_impact.mp3', vol: 0.55},
  {at: 1364, src: 'media/sfx_impact.mp3', vol: 0.72},
  {at: 1592, src: 'media/sfx_whoosh.mp3', vol: 0.4},
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>The productivity gap</span>
      </div>
...
// ---------------------------------------------------------------------------
export const PerHourReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('perhour/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('perhour/music.mp3')}
