...
// ---------------------------------------------------------------------------
// "What the fee buys" reel (PassiveReel) — active-vs-index myth-bust, told as the A/B twin of the
// existing ActiveReel ("The average wins"), which opens on the flat myth and closes on a red card.
// The consensus is that a paid professional with research and tools should beat a free, do-nothing
// index — but over 15 years about 90% of active large-cap funds underperform the S&P 500, and it
// isn't luck evening out: stretch to 20 years and the failure rate climbs to ~92%. Fees and
// trading costs drag the experts below the index they chase, and last stretch's winners rarely
// repeat, so the drag is structural, not bad picking — after fees, the average active dollar has
// to trail the market it collectively makes up. The index wins less by being clever than by being
// cheap and staying in. Question hook ("...nine out of ten pros lose to a strategy that takes zero
...
// the mid-tail thesis, and the question close on footage rather than the red card. Durations sit
// on exact ElevenLabs spoken-word timestamps at +6% pace; music normalized and mixed at 0.17.
// Total 1459 frames = ~48.6s. Entirely its own fresh footage under public/passive/ — no asset
// shared with ActiveReel, IndexReel, StillReel, or any other reel. **FLAG — real figures:** the
// "~90% of active large-cap funds trail the S&P 500 over 15 years / ~92% over 20" figures are the
// widely-cited SPIVA-style numbers but move with the window and dataset; verify before publishing.
// Imagery is generic — no fund/brokerage/index brands, tickers, or legible company marks.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 79, kind: 'hook', text: 'Nine out of ten|professionals—', kicker: 'What the fee buys', highlights: ['nine'], size: 80, media: {src: 'passive/v_hook.mp4', type: 'video', effect: 'in'}},
  {dur: 46, kind: 'text', text: 'lose to a|strategy—', highlights: ['lose'], size: 90},
  // Short ~1.5s pause after the hook (house convention): 45 frames of silence are spliced into
  // the VO right after "...that takes zero skill?", and this beat holds through it (36 -> 81).
  {dur: 81, kind: 'text', text: 'that takes|zero skill?', highlights: ['zero'], size: 88},
  {dur: 51, kind: 'text', text: 'It sounds|obvious.', highlights: ['obvious'], size: 92, media: {src: 'passive/p_pro.jpg', type: 'img', effect: 'in'}},
  {dur: 64, kind: 'text', enter: 'slideL', text: 'A pro with|research and tools.', highlights: ['research'], size: 84, media: {src: 'passive/p_desk.jpg', type: 'img', effect: 'in'}},
  {dur: 42, kind: 'text', text: 'Beats a free,|do-nothing index.', highlights: ['index'], size: 84, media: {src: 'passive/p_index.jpg', type: 'img', effect: 'in'}},
  {dur: 87, kind: 'text', text: 'But the data runs|the other way.', highlights: ['data'], size: 84, media: {src: 'passive/v_charts.mp4', type: 'video', effect: 'in'}},
  {dur: 127, kind: 'stat', stat: {pre: 'OVER 15 YEARS,', value: 90, suffix: '%', post: 'OF PROS TRAIL THE INDEX', bar: 90}},
  {dur: 78, kind: 'text', enter: 'slideL', text: 'Nine in ten.|Behind the average.', highlights: ['nine'], size: 82, media: {src: 'passive/p_group.jpg', type: 'img', effect: 'in'}},
  {dur: 45, kind: 'text', text: "And it isn't|luck evening out.", highlights: ['luck'], size: 84},
  {dur: 80, kind: 'text', text: 'Stretch to|twenty years—', highlights: ['twenty'], size: 88},
  {dur: 34, kind: 'stat', stat: {pre: 'AT 20 YEARS,', value: 92, suffix: '%', post: 'STILL TRAIL'}},
  {dur: 63, kind: 'text', text: 'Fees and|trading costs.', highlights: ['fees'], size: 90, media: {src: 'passive/p_fees.jpg', type: 'img', effect: 'in'}},
  {dur: 73, kind: 'text', enter: 'slideL', text: 'drag them below|the index.', highlights: ['below'], size: 86, media: {src: 'passive/v_money.mp4', type: 'video', effect: 'in'}},
  {dur: 65, kind: 'text', text: "Last year's winners|rarely repeat.", highlights: ['winners'], size: 82, media: {src: 'passive/p_market.jpg', type: 'img', effect: 'in'}},
  {dur: 50, kind: 'impact', text: 'The drag is|structural.', redBg: true},
  {dur: 103, kind: 'text', text: 'The average dollar|must trail.', highlights: ['trail'], size: 84, media: {src: 'passive/v_crowd.mp4', type: 'video', effect: 'in'}},
  {dur: 75, kind: 'text', text: 'The market they|collectively make.', highlights: ['collectively'], size: 82},
  {dur: 36, kind: 'text', text: 'Not by being|clever—', highlights: ['clever'], size: 90},
  {dur: 44, kind: 'text', enter: 'slideL', text: 'by being cheap|and staying in.', highlights: ['cheap'], size: 86, media: {src: 'passive/p_calm.jpg', type: 'img', effect: 'in'}},
  {dur: 100, kind: 'text', text: "If nine in ten|pros can't win—", highlights: ['win'], size: 82},
  {dur: 36, kind: 'text', enter: 'zoom', text: "what's the fee|paying for?", highlights: ['fee'], size: 84, media: {src: 'passive/v_close.mp4', type: 'video', effect: 'in'}},
];
...
const SFX: SfxCue[] = [
  {at: 206, src: 'media/sfx_whoosh.mp3', vol: 0.4},   // reveal after the pause
  {at: 450, src: 'media/sfx_impact.mp3', vol: 0.6},   // 90% stat
  {at: 780, src: 'media/sfx_impact.mp3', vol: 0.5},   // 92% stat
  {at: 1015, src: 'media/sfx_impact.mp3', vol: 0.72}, // red 'The drag is structural.' card
  {at: 1423, src: 'media/sfx_whoosh.mp3', vol: 0.4},  // question close
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>What the fee buys</span>
      </div>
...
// ---------------------------------------------------------------------------
export const PassiveReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('passive/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('passive/music.mp3')}
