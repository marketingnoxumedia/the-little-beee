...
// ---------------------------------------------------------------------------
// "The disgust moat" reel — portable sanitation (renting & servicing portable
// toilets for construction and events on recurring contracts) is protected by
// the very thing that makes people avoid it: nobody wants to run it, so nobody
// competes. Durations placed on exact spoken-word timestamps (ElevenLabs
// alignment) at +6% pace. Total 1604 frames = ~53.5s. `enter` adds a transition
// on some cuts. Every scene uses a distinct background sourced fresh for this
// reel — no footage is shared with any other reel (see the skill's hard rule).
// No count-up stat (margins vary too much by route to quote honestly); a red
// "gross is protection" card mid-tail, and a close on the units themselves
// ("that's the moat") rather than the red card.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 57, kind: 'hook', text: 'A cash-flow business|nobody wants|to run.', kicker: 'The disgust moat', highlights: ['nobody'], size: 74, media: {src: 'sanitation/v_constr.mp4', type: 'video', effect: 'in'}},
  {dur: 87, kind: 'text', text: 'Almost no|competition.', highlights: ['competition'], size: 92, media: {src: 'sanitation/p_lone.jpg', type: 'img', effect: 'in'}},
  {dur: 54, kind: 'text', enter: 'slideR', text: 'Nobody wants|to run it.', highlights: ['run'], size: 92, media: {src: 'sanitation/p_worker1.jpg', type: 'img', effect: 'in'}},
  {dur: 58, kind: 'text', text: 'What makes people|avoid it —', highlights: ['avoid'], size: 82, media: {src: 'sanitation/p_avoid.jpg', type: 'img', effect: 'in'}},
  {dur: 29, kind: 'text', text: 'is exactly|what protects it.', highlights: ['protects'], size: 88, media: {src: 'sanitation/p_fence.jpg', type: 'img', effect: 'in'}},
  {dur: 69, kind: 'text', enter: 'slideL', text: "It's portable|sanitation.", highlights: ['sanitation'], size: 92, media: {src: 'sanitation/p_row1.jpg', type: 'img', effect: 'in'}},
  {dur: 62, kind: 'text', text: 'Rent and service|portable toilets.', highlights: ['service'], size: 82, media: {src: 'sanitation/p_row2.jpg', type: 'img', effect: 'in'}},
  {dur: 57, kind: 'text', text: 'Construction sites.|And events.', highlights: ['construction'], size: 84, media: {src: 'sanitation/v_aerial.mp4', type: 'video', effect: 'in'}},
  {dur: 65, kind: 'text', text: 'On recurring|contracts.', highlights: ['recurring'], size: 92, media: {src: 'sanitation/p_contract.jpg', type: 'img', effect: 'in'}},
  {dur: 56, kind: 'text', text: "The moat is|other people's|reluctance.", highlights: ['reluctance'], size: 76},
  {dur: 49, kind: 'text', text: 'The work is|unpleasant enough', highlights: ['unpleasant'], size: 82, media: {src: 'sanitation/p_gloves.jpg', type: 'img', effect: 'in'}},
  {dur: 32, kind: 'text', text: "that rivals|don't rush in.", highlights: ['rivals'], size: 88, media: {src: 'sanitation/p_vacant.jpg', type: 'img', effect: 'in'}},
  {dur: 69, kind: 'text', enter: 'slideL', text: 'So pricing|stays rational.', highlights: ['rational'], size: 88, media: {src: 'sanitation/p_docs.jpg', type: 'img', effect: 'in'}},
  {dur: 57, kind: 'text', text: 'No brand.|No tech edge.', highlights: ['brand'], size: 96},
  {dur: 59, kind: 'text', text: 'The servicing|recurs.', highlights: ['recurs'], size: 92, media: {src: 'sanitation/p_gloves2.jpg', type: 'img', effect: 'in'}},
  {dur: 43, kind: 'text', text: 'Cleaned|on a schedule.', highlights: ['schedule'], size: 92, media: {src: 'sanitation/p_calendar1.jpg', type: 'img', effect: 'in'}},
  {dur: 125, kind: 'text', enter: 'slideL', text: 'Contracts renew|whether you notice|or not.', highlights: ['renew'], size: 76, media: {src: 'sanitation/p_calendar2.jpg', type: 'img', effect: 'in'}},
  {dur: 111, kind: 'text', text: 'Construction and events|guarantee demand.', highlights: ['demand'], size: 78, media: {src: 'sanitation/v_event.mp4', type: 'video', effect: 'in'}},
  {dur: 57, kind: 'text', enter: 'slideL', text: 'The unpleasantness|is the barrier.', highlights: ['barrier'], size: 80, media: {src: 'sanitation/p_row3.jpg', type: 'img', effect: 'in'}},
  {dur: 124, kind: 'text', text: 'Low competition.|Recurring revenue.', highlights: ['low'], size: 80, media: {src: 'sanitation/p_pair.jpg', type: 'img', effect: 'in'}},
  {dur: 75, kind: 'impact', text: 'Gross|is protection.', redBg: true},
  {dur: 119, kind: 'text', text: 'It defends|the ones|already in it.', highlights: ['defends'], size: 80, media: {src: 'sanitation/p_operator.jpg', type: 'img', effect: 'in'}},
  {dur: 31, kind: 'text', text: 'Nobody|wants it.', highlights: ['nobody'], size: 100, media: {src: 'sanitation/p_row4.jpg', type: 'img', effect: 'in'}},
  {dur: 27, kind: 'text', text: 'So nobody|enters.', highlights: ['enters'], size: 96, media: {src: 'sanitation/p_empty.jpg', type: 'img', effect: 'in'}},
  {dur: 32, kind: 'text', enter: 'zoom', text: "That's|the moat.", highlights: ['moat'], size: 100, media: {src: 'sanitation/p_topdown.jpg', type: 'img', effect: 'in'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 57, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 354, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 538, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 744, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 1139, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 1320, src: 'media/sfx_impact.mp3', vol: 0.72},
  {at: 1514, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 1572, src: 'media/sfx_impact.mp3', vol: 0.5},
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>The disgust moat</span>
      </div>
...
// ---------------------------------------------------------------------------
export const SanitationReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('sanitation/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('sanitation/music.mp3')}
