...
// ---------------------------------------------------------------------------
// "The ten-year head start" reel — two people save the same $500/mo at 7%; the
// one who starts at 25 ends near $1.3M, the one who starts at 35 near $610K. A
// ten-year delay roughly halves the result on barely less money in, because
// compounding pays the earliest dollars most: time did more of the work than the
// money. Durations placed on exact spoken-word timestamps (ElevenLabs alignment)
// at +6% pace. Total 1560 frames = ~52.0s. `enter` adds a transition on some
// cuts. Every scene uses a distinct background sourced fresh for this reel — no
// footage is shared with any other reel (see the skill's hard rule). Two count-up
// stat beats ($1.3M, $610K), a red "closer to half" card mid-tail, and a close on
// footage (the two outcomes) rather than the red card.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 137, kind: 'hook', text: 'Same $500|a month.', kicker: 'The ten-year head start', highlights: ['$500'], size: 82, media: {src: 'headstart/v_jar.mp4', type: 'video', effect: 'in'}},
  {dur: 52, kind: 'text', text: 'Same return,|whole careers.', highlights: ['careers'], size: 88, media: {src: 'headstart/p_career.jpg', type: 'img', effect: 'in'}},
  {dur: 90, kind: 'text', enter: 'slideR', text: 'One ends with|more than double.', highlights: ['double'], size: 86, media: {src: 'headstart/p_double.jpg', type: 'img', effect: 'in'}},
  {dur: 115, kind: 'text', text: 'The difference?|A ten-year|head start.', highlights: ['head'], size: 80, media: {src: 'headstart/p_clock.jpg', type: 'img', effect: 'in'}},
  {dur: 48, kind: 'text', text: '$500 a month.|Seven percent.', highlights: ['seven'], size: 88, media: {src: 'headstart/p_cash1.jpg', type: 'img', effect: 'in'}},
  {dur: 54, kind: 'text', text: 'Same amount.|Same market.', highlights: ['market'], size: 88, media: {src: 'headstart/p_cash2.jpg', type: 'img', effect: 'in'}},
  {dur: 34, kind: 'text', text: 'Only the|start date.', highlights: ['start'], size: 92, media: {src: 'headstart/p_calendar.jpg', type: 'img', effect: 'in'}},
  {dur: 93, kind: 'text', enter: 'slideL', text: 'Begin|at 25.', highlights: ['25'], size: 100, media: {src: 'headstart/p_young.jpg', type: 'img', effect: 'in'}},
  {dur: 184, kind: 'stat', stat: {pre: '$240K in, by age 65', prefix: '$', value: 1.3, decimals: 1, suffix: 'M'}},
  {dur: 69, kind: 'text', text: 'Now begin|at 35.', highlights: ['35'], size: 100, media: {src: 'headstart/p_older.jpg', type: 'img', effect: 'in'}},
  {dur: 64, kind: 'text', text: 'Pay in about|$60K less.', highlights: ['less'], size: 88, media: {src: 'headstart/p_coinsjar.jpg', type: 'img', effect: 'in'}},
  {dur: 69, kind: 'stat', stat: {pre: 'And you end near', prefix: '$', value: 610, suffix: 'K'}},
  {dur: 46, kind: 'text', text: 'A ten-year delay|halves it.', highlights: ['halves'], size: 86, media: {src: 'headstart/p_cash3.jpg', type: 'img', effect: 'in'}},
  {dur: 64, kind: 'text', enter: 'slideL', text: 'On barely less|money in.', highlights: ['barely'], size: 88, media: {src: 'headstart/p_coins2.jpg', type: 'img', effect: 'in'}},
  {dur: 44, kind: 'text', text: 'Compounding pays|on past growth.', highlights: ['compounding'], size: 82, media: {src: 'headstart/v_stacks.mp4', type: 'video', effect: 'in'}},
  {dur: 82, kind: 'text', enter: 'slideL', text: 'The earliest dollars|matter most.', highlights: ['earliest'], size: 82, media: {src: 'headstart/p_seedling.jpg', type: 'img', effect: 'in'}},
  {dur: 45, kind: 'text', text: "The first decade|isn't a quarter.", highlights: ['quarter'], size: 86},
  {dur: 42, kind: 'impact', text: "It's closer|to half.", redBg: true},
  {dur: 46, kind: 'text', enter: 'slideL', text: 'Time did more|than the money.', highlights: ['time'], size: 82, media: {src: 'headstart/p_hourglass.jpg', type: 'img', effect: 'in'}},
  {dur: 31, kind: 'text', text: "The gap wasn't|effort.", highlights: ['effort'], size: 92, media: {src: 'headstart/p_piggy2.jpg', type: 'img', effect: 'in'}},
  {dur: 27, kind: 'text', text: 'It was|years.', highlights: ['years'], size: 104},
  {dur: 40, kind: 'text', text: 'Same $500|a month.', highlights: ['$500'], size: 100, media: {src: 'headstart/p_cash4.jpg', type: 'img', effect: 'in'}},
  {dur: 84, kind: 'text', enter: 'zoom', text: '$1.3 million.|Or $610K.', highlights: ['$610k'], size: 92, media: {src: 'headstart/v_coins.mp4', type: 'video', effect: 'in'}},
];
...
const SFX: SfxCue[] = [
  ...
  {at: 623, src: 'media/sfx_impact.mp3', vol: 0.6},
  {at: 940, src: 'media/sfx_impact.mp3', vol: 0.55},
  {at: 1119, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 1290, src: 'media/sfx_impact.mp3', vol: 0.72},
  {at: 1476, src: 'media/sfx_impact.mp3', vol: 0.5},
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>The ten-year head start</span>
      </div>
...
// ---------------------------------------------------------------------------
export const HeadstartReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('headstart/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('headstart/music.mp3')}
