...
// ---------------------------------------------------------------------------
// "Paying for the name" reel — two products on the same shelf, one noticeably
// cheaper; in many cases they're made in the same factory, to the same standard,
// sometimes on the same production lines. A chunk of the brand premium buys the
// label, the marketing, and shelf position — not the contents. Sometimes the
// premium is justified (real quality/taste differences); sometimes it isn't. The
// only way to know is to compare the actual items. Durations placed on exact
// spoken-word timestamps (ElevenLabs alignment) at +6% pace. Total 1493 frames =
// ~49.8s. `enter` adds a transition on some cuts. Every scene uses a distinct
// background sourced fresh for this reel — no footage is shared with any other
// reel (see the skill's hard rule). Brand-safety is deliberate: shelves are
// blurred and all products are generic/unbranded — no real logos. Two black
// beats (s4, s18), one red "you buy the name" card near the tail, and a close on
// footage (the same maker) rather than the red card.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 68, kind: 'hook', text: 'Two products.|Same shelf.', kicker: 'Paying for the name', highlights: ['shelf'], size: 92, media: {src: 'brand/v_shelf.mp4', type: 'video', effect: 'in'}},
  {dur: 101, kind: 'text', text: "One's noticeably|cheaper.", highlights: ['cheaper'], size: 92, media: {src: 'brand/p_cheap.jpg', type: 'img', effect: 'in'}},
  {dur: 35, kind: 'text', text: 'Made in the|same factory.', highlights: ['same'], size: 90, media: {src: 'brand/p_factory1.jpg', type: 'img', effect: 'in'}},
  {dur: 43, kind: 'text', text: 'To the same|standard.', highlights: ['standard'], size: 92, media: {src: 'brand/p_factory2.jpg', type: 'img', effect: 'in'}},
  {dur: 89, kind: 'text', text: "You're paying|for the name.", highlights: ['name'], size: 92},
  {dur: 73, kind: 'text', enter: 'slideR', text: 'Name brand vs|store label.', highlights: ['store'], size: 88, media: {src: 'brand/p_twocans1.jpg', type: 'img', effect: 'in'}},
  {dur: 76, kind: 'text', text: 'The name brand|costs more.', highlights: ['more'], size: 90, media: {src: 'brand/p_pricetag1.jpg', type: 'img', effect: 'in'}},
  {dur: 92, kind: 'text', text: 'The store label|costs less.', highlights: ['less'], size: 90, media: {src: 'brand/p_saletags.jpg', type: 'img', effect: 'in'}},
  {dur: 44, kind: 'text', text: 'Not a better|product.', highlights: ['better'], size: 92, media: {src: 'brand/p_container.jpg', type: 'img', effect: 'in'}},
  {dur: 110, kind: 'text', enter: 'slideL', text: "It's the brand.|The marketing.", highlights: ['marketing'], size: 88, media: {src: 'brand/p_marketing.jpg', type: 'img', effect: 'in'}},
  {dur: 53, kind: 'text', text: 'Made to|similar standards.', highlights: ['similar'], size: 88, media: {src: 'brand/p_bottles.jpg', type: 'img', effect: 'in'}},
  {dur: 84, kind: 'text', enter: 'slideL', text: 'Sometimes the same|production lines.', highlights: ['same'], size: 82, media: {src: 'brand/v_line.mp4', type: 'video', effect: 'in'}},
  {dur: 32, kind: 'text', text: 'The premium pays|for the label.', highlights: ['label'], size: 82, media: {src: 'brand/p_can.jpg', type: 'img', effect: 'in'}},
  {dur: 38, kind: 'text', text: 'Not the|contents.', highlights: ['contents'], size: 96, media: {src: 'brand/p_jar.jpg', type: 'img', effect: 'in'}},
  {dur: 60, kind: 'text', text: 'Shelf position.|Advertising.', highlights: ['advertising'], size: 86, media: {src: 'brand/p_shelf.jpg', type: 'img', effect: 'in'}},
  {dur: 43, kind: 'text', text: "Not what's|inside.", highlights: ['inside'], size: 92, media: {src: 'brand/p_box.jpg', type: 'img', effect: 'in'}},
  {dur: 67, kind: 'text', enter: 'slideR', text: "Sometimes it's|justified.", highlights: ['justified'], size: 90, media: {src: 'brand/p_market.jpg', type: 'img', effect: 'in'}},
  {dur: 50, kind: 'text', text: 'Real quality|or taste.', highlights: ['quality'], size: 90, media: {src: 'brand/p_food.jpg', type: 'img', effect: 'in'}},
  {dur: 60, kind: 'text', text: 'Sometimes|it isn\'t.', highlights: ["isn't"], size: 100},
  {dur: 44, kind: 'text', text: 'Compare the|actual items.', highlights: ['compare'], size: 90, media: {src: 'brand/p_twocans2.jpg', type: 'img', effect: 'in'}},
  {dur: 89, kind: 'text', enter: 'slideL', text: 'Ingredients.|Specs. Reviews.', highlights: ['specs'], size: 86, media: {src: 'brand/p_pouches.jpg', type: 'img', effect: 'in'}},
  {dur: 63, kind: 'impact', text: 'The specs match?|You buy the name.', redBg: true},
  {dur: 47, kind: 'text', text: 'Same shelf.|Two prices.', highlights: ['two'], size: 96, media: {src: 'brand/p_pricetag2.jpg', type: 'img', effect: 'in'}},
  {dur: 32, kind: 'text', enter: 'zoom', text: 'Sometimes the|same maker.', highlights: ['maker'], size: 92, media: {src: 'brand/v_close.mp4', type: 'video', effect: 'in'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 68, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 247, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 621, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 998, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 1351, src: 'media/sfx_impact.mp3', vol: 0.72},
  {at: 1461, src: 'media/sfx_impact.mp3', vol: 0.5},
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>Paying for the name</span>
      </div>
...
export const BrandReel: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('brand/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('brand/music.mp3')}
