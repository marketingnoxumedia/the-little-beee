...
// ---------------------------------------------------------------------------
// "The certain market" reel (CertainReel) — Service Corporation International,
// told as a QUESTION-hook / question-close A/B twin of SciReel (declarative
// cut). Same case — a company that quietly consolidates funeral homes and
// cemeteries under local names, funded by pre-need contracts years in advance,
// at ~22% operating margins — but this cut opens on a question ("Do you know
// this company? … almost none know its name") and closes on one ("How many
// others are you walking past?"). Durations on exact ElevenLabs spoken-word
// timestamps at +6% pace; a ~1.2s post-hook pause is spliced into the VO right
// after the hook question ("…know its name?"), and beat 2 holds through it
// (57 -> 93). Total 1697 frames = ~56.6s. **Media-dense:** 20 of 23 beats carry
// footage, with only 2 flat-black beats ("Almost none know its name.", "The
// consolidation is invisible by design.") plus one red `impact` card ("No
// marketing war. No demand risk.") as the mid-tail thesis; the close lands on
// footage. Every scene uses its own footage under public/certain/ — no asset
// shared with SciReel or any other reel (skill hard rule). **Brand-safety:**
// SCI is named in voiceover only — all footage is generic, with NO funeral-home
// business names, NO legible headstone names, NO brand marks. **Real
// company/figures — verify:** the 700K families, ~1,490 homes, 496 cemeteries,
// $4.186B revenue, ~22% operating margin, and $928M operating income are
// rendered as written; double-check before publishing. Same topic as SciReel —
// publish only one twin to a given audience, scheduled apart.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 37, kind: 'hook', text: 'Do you know|this company?', kicker: 'The certain market', highlights: ['know'], size: 84, media: {src: 'certain/p_street.jpg', type: 'img', effect: 'in'}},
  {dur: 102, kind: 'stat', stat: {pre: 'It serves', value: 700, suffix: 'K', post: 'families a year'}, media: {src: 'certain/p_lily.jpg', type: 'img', effect: 'in'}},
  // 57 -> 93: a 36-frame (~1.2s) pause is spliced into the VO right after the
  // hook question ("…know its name?"), and this beat holds through it.
  {dur: 93, kind: 'text', text: 'Almost none|know its name.', highlights: ['name'], size: 88},
  {dur: 106, kind: 'text', enter: 'slideL', text: 'It runs funeral homes|under local signs.', highlights: ['signs'], size: 74, media: {src: 'certain/p_chapel.jpg', type: 'img', effect: 'in'}},
  {dur: 57, kind: 'text', text: 'Service Corporation|International.', highlights: ['international'], size: 74, media: {src: 'certain/v_corp.mp4', type: 'video', effect: 'in'}},
  {dur: 87, kind: 'text', text: 'Funeral homes|and cemeteries|across North America.', highlights: ['cemeteries'], size: 72, media: {src: 'certain/p_cemetery.jpg', type: 'img', effect: 'panL'}},
  {dur: 95, kind: 'text', enter: 'slideR', text: 'Local names you’d|never link|to one company.', highlights: ['link'], size: 72, media: {src: 'certain/p_shopfront.jpg', type: 'img', effect: 'in'}},
  {dur: 71, kind: 'text', text: 'The consolidation|is invisible|by design.', highlights: ['invisible'], size: 80},
  {dur: 52, kind: 'text', text: 'The local name stays|on the building.', highlights: ['building'], size: 80, media: {src: 'certain/p_facade.jpg', type: 'img', effect: 'in'}},
  {dur: 95, kind: 'text', text: 'Families never|comparison-shop.', highlights: ['comparisonshop'], size: 78, media: {src: 'certain/p_pews.jpg', type: 'img', effect: 'panR'}},
  {dur: 52, kind: 'text', text: 'Demand arrives|without marketing.', highlights: ['marketing'], size: 82, media: {src: 'certain/p_reception.jpg', type: 'img', effect: 'in'}},
  {dur: 62, kind: 'text', text: 'And without reference|to the economy.', highlights: ['economy'], size: 80, media: {src: 'certain/v_ticker.mp4', type: 'video', effect: 'in'}},
  {dur: 88, kind: 'text', enter: 'slideL', text: 'Pre-need contracts|collect years|in advance.', highlights: ['years'], size: 74, media: {src: 'certain/p_signing.jpg', type: 'img', effect: 'in'}},
  {dur: 70, kind: 'text', text: 'Customers fund it|themselves.', highlights: ['themselves'], size: 82, media: {src: 'certain/p_savings.jpg', type: 'img', effect: 'in'}},
  {dur: 70, kind: 'stat', stat: {pre: 'About', value: 1490, post: 'funeral homes'}, media: {src: 'certain/p_rooftops.jpg', type: 'img', effect: 'in'}},
  {dur: 75, kind: 'stat', stat: {pre: 'And', value: 496, post: 'cemeteries'}, media: {src: 'certain/p_memorialpark.jpg', type: 'img', effect: 'in'}},
  {dur: 113, kind: 'stat', stat: {pre: 'Revenue', prefix: '$', value: 4.186, decimals: 3, suffix: 'B'}, media: {src: 'certain/p_cash.jpg', type: 'img', effect: 'in'}},
  {dur: 67, kind: 'stat', stat: {pre: 'Operating margin', value: 22, suffix: '%', bar: 22}, media: {src: 'certain/p_calc.jpg', type: 'img', effect: 'in'}},
  {dur: 77, kind: 'stat', stat: {pre: 'Operating income', prefix: '$', value: 928, suffix: 'M'}, media: {src: 'certain/p_coins.jpg', type: 'img', effect: 'in'}},
  {dur: 61, kind: 'impact', text: 'No marketing war.|No demand risk.', redBg: true},
  {dur: 46, kind: 'text', enter: 'zoom', text: 'The most certain|market on earth.', highlights: ['certain'], size: 80, media: {src: 'certain/v_candle.mp4', type: 'video', effect: 'in'}},
  {dur: 60, kind: 'text', text: 'The safest business|in the country.', highlights: ['safest'], size: 78, media: {src: 'certain/p_flag.jpg', type: 'img', effect: 'in'}},
  {dur: 61, kind: 'text', enter: 'zoom', text: 'How many others|are you walking past?', highlights: ['past?'], size: 74, media: {src: 'certain/v_road.mp4', type: 'video', effect: 'in'}},
];
...
// 196), so every cue below is already on the post-pause timeline.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 37, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 232, src: 'media/sfx_whoosh.mp3', vol: 0.45},
  {at: 577, src: 'media/sfx_impact.mp3', vol: 0.45},
  {at: 1067, src: 'media/sfx_whoosh.mp3', vol: 0.45},
  {at: 1212, src: 'media/sfx_chaching.mp3', vol: 0.55},
  {at: 1469, src: 'media/sfx_impact.mp3', vol: 0.6},
  {at: 1636, src: 'media/sfx_whoosh.mp3', vol: 0.4},
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>The certain market</span>
      </div>
...
// ---------------------------------------------------------------------------
export const CertainReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('certain/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('certain/music.mp3')}
