...
// ---------------------------------------------------------------------------
// "The autopay trap" reel (AutopayReel) — the A/B twin of DriftReel:
// same forgotten-subscription case, but where DriftReel/PhantomReel land on the
// perception gap (you spend more than you think), this cut leads on the
// COMPOUNDING OPPORTUNITY COST of one $50/mo sub over ten years — $6,000 paid in
// for access you barely use vs ~$8,700 if that same $50 were invested at an
// assumed 7%. Opens on a question hook ("A forgotten $50 sub — what's a decade
// cost?") with a ~1.2s post-hook pause held on beat 0 (129 -> 165), lands the red
// thesis card "Small / Recurring" mid-tail, and closes on a question ("Which one
// would you actually miss?"). Durations on exact ElevenLabs spoken-word
// timestamps at +6% pace. Total 1358 frames = ~45.3s. **Media-dense:** 15 of 18
// beats carry footage, with only 2 flat-black beats ("None of it is felt month to
// month.", "The point was never to cancel everything.") plus the one red card;
// the close lands on footage. Own footage under public/autopay/ — no asset shared
// with DriftReel, PhantomReel, or any other reel (skill hard rule).
// **Illustrative figures — verify before publishing:** the $50/mo, 7% return,
// $6,000-paid and ~$8,700-compounded numbers are round-number arithmetic on
// stated assumptions, not a claim about any specific product or period; real
// returns vary by year. Same forgotten-subscription case as DriftReel and
// PhantomReel — publish only one subscription reel to a given audience.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  // beat 0 holds through the ~1.2s post-hook pause spliced after "…ten years?" (129 -> 165).
  {dur: 165, kind: 'hook', text: 'A forgotten $50 sub.|What\'s a decade cost?', kicker: 'The autopay trap', highlights: ['$50'], size: 74, media: {src: 'autopay/p_remote.jpg', type: 'img', effect: 'in'}},
  {dur: 66, kind: 'text', text: 'Take one sub|you rarely open.', highlights: ['rarely'], size: 80, media: {src: 'autopay/p_facedown.jpg', type: 'img', effect: 'in'}},
  {dur: 35, kind: 'text', text: 'Keep it|ten years.', highlights: ['ten'], size: 92, media: {src: 'autopay/p_calendar10.jpg', type: 'img', effect: 'in'}},
  {dur: 104, kind: 'text', enter: 'slideL', text: 'Or invest that $50|at seven percent.', highlights: ['invest'], size: 76, media: {src: 'autopay/p_investjar.jpg', type: 'img', effect: 'in'}},
  {dur: 57, kind: 'stat', stat: {pre: 'Kept, you pay in', prefix: '$', value: 6000}, media: {src: 'autopay/v_drain.mp4', type: 'video', effect: 'in'}},
  {dur: 55, kind: 'text', text: 'For access you|hardly touch.', highlights: ['hardly'], size: 80, media: {src: 'autopay/p_dust.jpg', type: 'img', effect: 'in'}},
  {dur: 114, kind: 'stat', stat: {pre: 'Invested, it compounds to', prefix: '$', value: 8700}, media: {src: 'autopay/p_plantcoins.jpg', type: 'img', effect: 'in'}},
  {dur: 72, kind: 'text', text: 'Same money in.|Two different endings.', highlights: ['different'], size: 76, media: {src: 'autopay/p_twojars.jpg', type: 'img', effect: 'in'}},
  {dur: 69, kind: 'text', text: 'The difference isn\'t|the fifty dollars.', highlights: ['fifty'], size: 76, media: {src: 'autopay/p_banknote.jpg', type: 'img', effect: 'in'}},
  {dur: 45, kind: 'text', text: 'It drifts out|on autopay.', highlights: ['autopay'], size: 82, media: {src: 'autopay/p_card.jpg', type: 'img', effect: 'in'}},
  {dur: 59, kind: 'text', text: 'Or it compounds|on purpose.', highlights: ['purpose'], size: 82, media: {src: 'autopay/v_compound.mp4', type: 'video', effect: 'in'}},
  {dur: 65, kind: 'text', text: 'None of it is felt|month to month.', highlights: ['month'], size: 82},
  {dur: 92, kind: 'text', enter: 'slideL', text: 'A decade slips by|unexamined.', highlights: ['unexamined'], size: 78, media: {src: 'autopay/p_hourglass.jpg', type: 'img', effect: 'in'}},
  {dur: 56, kind: 'impact', text: 'Small.|Recurring.', redBg: true},
  {dur: 69, kind: 'text', text: 'Small to ignore.|Large enough to matter.', highlights: ['matter'], size: 74, media: {src: 'autopay/p_smallcoins.jpg', type: 'img', effect: 'in'}},
  {dur: 60, kind: 'text', text: 'The point was never|to cancel everything.', highlights: ['everything'], size: 74},
  {dur: 121, kind: 'text', enter: 'slideL', text: 'Only to choose|where it goes.', highlights: ['choose'], size: 80, media: {src: 'autopay/p_fork.jpg', type: 'img', effect: 'in'}},
  {dur: 54, kind: 'text', enter: 'zoom', text: 'Which one would you|actually miss?', highlights: ['miss?'], size: 78, media: {src: 'autopay/v_reflect.mp4', type: 'video', effect: 'in'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
// NOTE: a 36-frame (~1.2s) pause is spliced after the hook question (frame 129);
// the whoosh sits on the post-pause reveal, impacts on the two stat reveals
// ($6,000 / $8,700) and the red thesis card.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 165, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 370, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 482, src: 'media/sfx_impact.mp3', vol: 0.55},
  {at: 998, src: 'media/sfx_impact.mp3', vol: 0.6},
  {at: 1304, src: 'media/sfx_whoosh.mp3', vol: 0.4},
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>The autopay trap</span>
      </div>
...
// ---------------------------------------------------------------------------
export const AutopayReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('autopay/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('autopay/music.mp3')}
