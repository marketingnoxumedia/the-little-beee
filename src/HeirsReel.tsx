...
// ---------------------------------------------------------------------------
// "Building vs keeping" reel (HeirsReel) — why so many family fortunes vanish
// within three generations: the skill that BUILDS wealth and the skill that
// KEEPS it are almost opposites. Building is mostly an individual achievement
// (earn, save, invest, let time compound); keeping it is a coordination problem
// spread across decades and many heirs, resting on governance, discipline, and
// shared values holding up in every generation. Creation rewards concentration
// and risk; preservation rewards diversification and restraint — so the very
// mindset that makes a fortune doesn't automatically protect one, and
// overspending, division among heirs, or lost discipline can erode what took a
// lifetime to build. Lasting wealth rests on stewardship, a distinct skill.
// Question hook ("Fortunes gone in 3 generations?") with a ~1.2s post-hook
// pause, red `impact` card ("The mindset that makes it / won't protect it.")
// mid-reel, and a question close ("Harder to make it, or make it last?").
// Durations on exact ElevenLabs spoken-word timestamps at +6% pace; the pause is
// spliced into the VO right after the hook question ("…three generations?") and
// beat 0 holds through it (110 -> 146). Total 1561 frames = ~52s. **Media-dense:**
// 18 of 21 beats carry footage, with only 2 flat-black beats ("Let time
// compound.", "Not just a big starting number.") plus the one red card; the
// close lands on footage. Own footage under public/heirs/ — no asset shared with
// any other reel (skill hard rule). **Conceptual — no hard figures:** the only
// number is "three generations" (the widely-cited "shirtsleeves to shirtsleeves"
// pattern), used as framing, not a precise statistic.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 146, kind: 'hook', text: 'Fortunes gone|in 3 generations?', kicker: 'Building vs keeping', highlights: ['3'], size: 84, media: {src: 'heirs/p_estate.jpg', type: 'img', effect: 'in'}},
  {dur: 40, kind: 'text', text: 'The skill that|builds it.', highlights: ['builds'], size: 84, media: {src: 'heirs/p_builder.jpg', type: 'img', effect: 'in'}},
  {dur: 127, kind: 'text', enter: 'slideL', text: 'And the skill|that keeps it.', highlights: ['keeps'], size: 84, media: {src: 'heirs/p_vault.jpg', type: 'img', effect: 'in'}},
  {dur: 69, kind: 'text', text: 'Two different|challenges.', highlights: ['different'], size: 86, media: {src: 'heirs/p_fork.jpg', type: 'img', effect: 'in'}},
  {dur: 74, kind: 'text', text: 'They reward|opposite instincts.', highlights: ['opposite'], size: 78, media: {src: 'heirs/p_opposite.jpg', type: 'img', effect: 'in'}},
  {dur: 42, kind: 'text', text: 'Building is|an individual feat.', highlights: ['individual'], size: 78, media: {src: 'heirs/p_solo.jpg', type: 'img', effect: 'in'}},
  {dur: 50, kind: 'lines', text: 'Earn.|Save.|Invest.', highlights: ['invest'], reveal: [2, 20, 40], media: {src: 'heirs/v_growth.mp4', type: 'video', effect: 'in'}},
  {dur: 52, kind: 'text', text: 'Let time|compound.', highlights: ['compound'], size: 92},
  {dur: 71, kind: 'text', text: 'Keeping it is|coordination.', highlights: ['coordination'], size: 80, media: {src: 'heirs/p_meeting.jpg', type: 'img', effect: 'in'}},
  {dur: 41, kind: 'text', text: 'Across decades,|many heirs.', highlights: ['heirs'], size: 84, media: {src: 'heirs/p_family.jpg', type: 'img', effect: 'in'}},
  {dur: 94, kind: 'lines', text: 'Governance.|Discipline.|Shared values.', highlights: ['values'], reveal: [2, 30, 58], media: {src: 'heirs/p_handshake.jpg', type: 'img', effect: 'in'}},
  {dur: 57, kind: 'text', text: 'Every generation.|Not just the builder.', highlights: ['builder'], size: 76, media: {src: 'heirs/p_generations.jpg', type: 'img', effect: 'in'}},
  {dur: 74, kind: 'text', enter: 'slideL', text: 'Creation rewards|risk.', highlights: ['risk'], size: 84, media: {src: 'heirs/p_risk.jpg', type: 'img', effect: 'in'}},
  {dur: 113, kind: 'text', text: 'Preservation rewards|restraint.', highlights: ['restraint'], size: 80, media: {src: 'heirs/p_restraint.jpg', type: 'img', effect: 'in'}},
  {dur: 85, kind: 'impact', text: 'The mindset that makes it|won\'t protect it.', redBg: true},
  {dur: 116, kind: 'lines', text: 'Overspending.|Division.|Lost discipline.', highlights: ['division'], reveal: [2, 34, 64], media: {src: 'heirs/p_spending.jpg', type: 'img', effect: 'in'}},
  {dur: 55, kind: 'text', text: 'Erodes a|lifetime\'s work.', highlights: ['erodes'], size: 84, media: {src: 'heirs/p_erosion.jpg', type: 'img', effect: 'in'}},
  {dur: 48, kind: 'text', enter: 'slideL', text: 'Lasting wealth rests|on stewardship.', highlights: ['stewardship'], size: 76, media: {src: 'heirs/p_steward.jpg', type: 'img', effect: 'in'}},
  {dur: 57, kind: 'text', text: 'Not just a big|starting number.', highlights: ['number'], size: 82},
  {dur: 57, kind: 'text', text: 'Preservation is|its own skill.', highlights: ['skill'], size: 82, media: {src: 'heirs/p_craft.jpg', type: 'img', effect: 'in'}},
  {dur: 93, kind: 'text', enter: 'zoom', text: 'Harder to make it,|or make it last?', highlights: ['last?'], size: 80, media: {src: 'heirs/v_legacy.mp4', type: 'video', effect: 'in'}},
];
...
// 110), so every cue below is already on the post-pause timeline.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 146, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 498, src: 'media/sfx_impact.mp3', vol: 0.45},
  {at: 712, src: 'media/sfx_impact.mp3', vol: 0.45},
  {at: 1050, src: 'media/sfx_impact.mp3', vol: 0.6},
  {at: 1135, src: 'media/sfx_impact.mp3', vol: 0.45},
  {at: 1468, src: 'media/sfx_whoosh.mp3', vol: 0.4},
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>Building vs keeping</span>
      </div>
...
// ---------------------------------------------------------------------------
export const HeirsReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('heirs/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('heirs/music.mp3')}
