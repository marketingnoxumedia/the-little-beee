...
// ---------------------------------------------------------------------------
// "Store of value" reel — gold is called the ultimate store of value, but over a
// century stocks didn't just beat it, they buried it. A dollar in US stocks in 1926
// grew, after inflation, to ~$1,081 by 2025; the same dollar in gold reached only
// ~$5. Gold roughly held its purchasing power; stocks multiplied it hundreds of
// times because the businesses behind them reinvest and grow, while gold pays no
// dividend and earns only what the next buyer will pay. The mix-up is between safe
// and growing: gold is a hedge that preserves, stocks are a stake that expands —
// both real jobs, but only one compounds. Durations placed on exact spoken-word
// timestamps (ElevenLabs alignment) at +6% pace. Total 1896 frames = ~63.2s.
// `enter` adds a transition on some cuts. Every scene uses a distinct background
// sourced fresh for this reel — no footage is shared with any other reel (see the
// skill's hard rule). Two count-up stats ($1,081 vs $5), two black beats, a red
// "both real jobs / only one compounds" card near the tail, and a close on footage
// (the two outcomes) rather than the red card. Long-run figures are illustrative —
// verify the exact numbers/series before publishing.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 88, kind: 'hook', text: 'Gold. The ultimate|store of value.', kicker: 'Store of value', highlights: ['gold'], size: 88, media: {src: 'gold/v_gold.mp4', type: 'video', effect: 'in'}},
  {dur: 70, kind: 'text', enter: 'slideR', text: 'The safe place|for the long run.', highlights: ['safe'], size: 88, media: {src: 'gold/p_vault.jpg', type: 'img', effect: 'in'}},
  {dur: 67, kind: 'text', text: 'Over a century,|stocks won.', highlights: ['stocks'], size: 90, media: {src: 'gold/v_chart.mp4', type: 'video', effect: 'in'}},
  {dur: 30, kind: 'text', text: 'They|buried it.', highlights: ['buried'], size: 104},
  {dur: 99, kind: 'text', text: 'Gold is tangible.|A fair belief.', highlights: ['tangible'], size: 88, media: {src: 'gold/p_goldcoins.jpg', type: 'img', effect: 'in'}},
  {dur: 97, kind: 'text', text: 'Centuries of|history.', highlights: ['history'], size: 96, media: {src: 'gold/p_goldhistory.jpg', type: 'img', effect: 'in'}},
  {dur: 60, kind: 'text', text: 'It rises in|the crises.', highlights: ['crises'], size: 92, media: {src: 'gold/p_crisis.jpg', type: 'img', effect: 'in'}},
  {dur: 29, kind: 'text', text: 'But.|Measure it.', highlights: ['measure'], size: 100},
  {dur: 103, kind: 'text', enter: 'slideL', text: 'A dollar in stocks.|1926.', highlights: ['1926'], size: 92, media: {src: 'gold/p_ticker.jpg', type: 'img', effect: 'in'}},
  {dur: 48, kind: 'text', text: 'Grown, after|inflation.', highlights: ['inflation'], size: 92, media: {src: 'gold/p_inflation.jpg', type: 'img', effect: 'in'}},
  {dur: 104, kind: 'stat', stat: {pre: 'By 2025, one dollar', prefix: '$', value: 1081}},
  {dur: 42, kind: 'text', text: 'The same dollar|in gold.', highlights: ['gold'], size: 92, media: {src: 'gold/p_goldbar.jpg', type: 'img', effect: 'in'}},
  {dur: 59, kind: 'stat', stat: {pre: 'Reached only', prefix: '$', value: 5}},
  {dur: 58, kind: 'text', text: 'Gold just held|its value.', highlights: ['held'], size: 90, media: {src: 'gold/p_goldstack.jpg', type: 'img', effect: 'in'}},
  {dur: 79, kind: 'text', text: 'Stocks multiplied it|hundreds of times.', highlights: ['hundreds'], size: 84, media: {src: 'gold/p_growth.jpg', type: 'img', effect: 'in'}},
  {dur: 126, kind: 'text', enter: 'slideL', text: 'No dividend.|Earns nothing.', highlights: ['nothing'], size: 90, media: {src: 'gold/p_nodiv.jpg', type: 'img', effect: 'in'}},
  {dur: 79, kind: 'text', text: 'Stocks|compound.', highlights: ['compound'], size: 98, media: {src: 'gold/p_business.jpg', type: 'img', effect: 'in'}},
  {dur: 82, kind: 'text', text: 'Businesses reinvest|and grow.', highlights: ['grow'], size: 88, media: {src: 'gold/p_reinvest.jpg', type: 'img', effect: 'in'}},
  {dur: 30, kind: 'text', text: 'Safe versus|growing.', highlights: ['growing'], size: 96, media: {src: 'gold/p_scale.jpg', type: 'img', effect: 'in'}},
  {dur: 109, kind: 'text', text: 'Gold is a hedge.|It preserves.', highlights: ['hedge'], size: 90, media: {src: 'gold/p_hedge.jpg', type: 'img', effect: 'in'}},
  {dur: 42, kind: 'text', text: 'Stocks are a stake|that expands.', highlights: ['expands'], size: 88, media: {src: 'gold/p_expand.jpg', type: 'img', effect: 'in'}},
  {dur: 86, kind: 'impact', text: 'Both real jobs.|Only one compounds.', redBg: true},
  {dur: 129, kind: 'text', enter: 'slideL', text: "Preserving isn't|growing.", highlights: ['preserving'], size: 90, media: {src: 'gold/p_time.jpg', type: 'img', effect: 'in'}},
  {dur: 35, kind: 'text', text: 'What barely|grows.', highlights: ['barely'], size: 94, media: {src: 'gold/p_slow.jpg', type: 'img', effect: 'in'}},
  {dur: 32, kind: 'text', text: 'Quietly falls|behind.', highlights: ['behind'], size: 94, media: {src: 'gold/p_behind.jpg', type: 'img', effect: 'in'}},
  {dur: 57, kind: 'text', text: 'In stocks:|a thousand.', highlights: ['thousand'], size: 92, media: {src: 'gold/p_stocks.jpg', type: 'img', effect: 'in'}},
  {dur: 56, kind: 'text', enter: 'zoom', text: 'In gold:|about five.', highlights: ['five'], size: 96, media: {src: 'gold/v_close.mp4', type: 'video', effect: 'in'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 158, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 225, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 691, src: 'media/sfx_chaching.mp3', vol: 0.55},
  {at: 837, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 1159, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 1501, src: 'media/sfx_impact.mp3', vol: 0.72},
  {at: 1840, src: 'media/sfx_impact.mp3', vol: 0.5},
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>Store of value</span>
      </div>
...
// ---------------------------------------------------------------------------
export const GoldReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('gold/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('gold/music.mp3')}
