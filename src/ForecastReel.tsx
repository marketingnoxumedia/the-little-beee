...
// ---------------------------------------------------------------------------
// "What a forecast is worth" reel (ForecastReel) — AT&T's 1980 mobile-phone forecast miss, told
// as the A/B twin of the existing AttReel ("The forecast trap"), which is a shorter, older,
// declarative cut. AT&T's Bell Labs invented cellular technology, then in 1980 asked McKinsey how
// big US mobile would get by 2000; the study came back at ~900,000 subscribers — a rounding error
// next to the wired network. Saying no looked disciplined: handsets were heavy, coverage thin, and
// the wired business was the crown jewel, so betting on a gadget the study called tiny was hard to
// justify to a board, and AT&T stepped back. By 2000 the US had over 100 million cellular
// subscribers — the forecast undershot reality by more than 120x — and to get back into the
// business it had walked away from, AT&T bought McCaw Cellular in 1994 for ~$12.6 billion. The
// lesson: a forecast isn't the future; even the company that invented the technology mistook a
// slow start for a small market. Question hook ("...pay $12.6 billion to undo one bad forecast?")
// and a rhetorical question close ("what's any forecast actually worth?"); a ~1.5s post-hook pause
// (the hook holds through the silence before the reveal — house convention); four count-up `stat`
// beats (900K / 100M / 120x / $12.6B), a red "A forecast isn't the future." `impact` card as the
// mid-tail thesis, and the question close on footage rather than the red card. Durations sit on
// exact ElevenLabs spoken-word timestamps at +6% pace; music normalized and mixed at 0.17. Total
// 1753 frames = ~58.4s. Entirely its own fresh footage under public/forecast/ — no asset shared
// with AttReel or any other reel. **Real company / real figures (FLAG):** AT&T, Bell Labs,
// McKinsey, and the McCaw acquisition are named as written; the ~900K-forecast / 100M-by-2000 /
// ~120x / ~$12.6B (1994) figures are widely cited but approximate and should be verified before
// publishing. Imagery is generic — no AT&T/McKinsey/phone-maker/carrier logos or legible marks.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 102, kind: 'hook', text: 'How does a firm pay|$12.6 billion—', kicker: 'What a forecast is worth', highlights: ['billion'], size: 74, media: {src: 'forecast/v_hook.mp4', type: 'video', effect: 'in'}},
  // Short ~1.5s pause after the hook (house convention): 45 frames of silence are spliced into
  // the VO right after "...to undo one bad forecast?", and this beat holds through it (59 -> 104).
  {dur: 104, kind: 'text', text: 'to undo one|bad forecast?', highlights: ['forecast?'], size: 82},
  {dur: 74, kind: 'text', text: 'In 1980, AT&T|ran a study.', highlights: ['study'], size: 84, media: {src: 'forecast/p_study.jpg', type: 'img', effect: 'in'}},
  {dur: 110, kind: 'text', enter: 'slideL', text: 'How big would|mobile phones get?', highlights: ['mobile'], size: 82, media: {src: 'forecast/p_brick.jpg', type: 'img', effect: 'in'}},
  {dur: 47, kind: 'text', text: 'The answer was off|by a hundredfold.', highlights: ['hundredfold'], size: 82},
  {dur: 86, kind: 'text', text: "AT&T's Bell Labs|invented cellular.", highlights: ['invented'], size: 84, media: {src: 'forecast/v_lab.mp4', type: 'video', effect: 'in'}},
  {dur: 41, kind: 'text', text: 'So it asked|McKinsey.', highlights: ['mckinsey'], size: 92, media: {src: 'forecast/v_board.mp4', type: 'video', effect: 'in'}},
  {dur: 60, kind: 'text', text: 'US mobile,|by 2000.', highlights: ['2000'], size: 88},
  {dur: 60, kind: 'stat', stat: {pre: 'MCKINSEY PROJECTED', value: 900, suffix: 'K', post: 'BY 2000'}, media: {src: 'forecast/p_chart.jpg', type: 'img', effect: 'in'}},
  {dur: 81, kind: 'text', enter: 'slideL', text: 'A rounding error|beside the network.', highlights: ['rounding'], size: 80, media: {src: 'forecast/p_wired.jpg', type: 'img', effect: 'in'}},
  {dur: 72, kind: 'text', text: 'The no looked|disciplined.', highlights: ['disciplined'], size: 88},
  {dur: 55, kind: 'text', text: 'Handsets were|heavy and costly.', highlights: ['heavy'], size: 86},
  {dur: 56, kind: 'text', text: 'The wired business|was the crown jewel.', highlights: ['crown'], size: 80},
  {dur: 92, kind: 'text', text: 'A gadget the study|called tiny.', highlights: ['tiny'], size: 86},
  {dur: 81, kind: 'text', text: 'So AT&T|stepped back.', highlights: ['back'], size: 92},
  {dur: 70, kind: 'stat', stat: {pre: 'BY 2000, THE US HAD', value: 100, suffix: 'M', post: 'SUBSCRIBERS'}, media: {src: 'forecast/v_crowd.mp4', type: 'video', effect: 'in'}},
  {dur: 55, kind: 'text', text: 'The forecast|undershot reality.', highlights: ['undershot'], size: 84, media: {src: 'forecast/p_tower.jpg', type: 'img', effect: 'in'}},
  {dur: 43, kind: 'stat', stat: {pre: 'IT MISSED BY OVER', value: 120, suffix: '×'}},
  {dur: 52, kind: 'text', text: 'To get back into|the business—', highlights: ['business'], size: 84},
  {dur: 103, kind: 'text', enter: 'slideL', text: 'AT&T bought|McCaw Cellular.', highlights: ['mccaw'], size: 86, media: {src: 'forecast/p_deal.jpg', type: 'img', effect: 'in'}},
  {dur: 33, kind: 'stat', stat: {pre: 'IN 1994, FOR', prefix: '$', value: 12.6, decimals: 1, suffix: 'B'}, media: {src: 'forecast/p_money.jpg', type: 'img', effect: 'in'}},
  {dur: 69, kind: 'impact', text: "A forecast|isn't the future.", redBg: true},
  {dur: 60, kind: 'text', text: 'The firm that|invented it—', highlights: ['invented'], size: 84},
  {dur: 43, kind: 'text', text: 'mistook a slow start|for a small one.', highlights: ['small'], size: 82},
  {dur: 64, kind: 'text', enter: 'slideL', text: 'If the people who|built the future—', highlights: ['built'], size: 80, media: {src: 'forecast/v_close.mp4', type: 'video', effect: 'in'}},
  {dur: 40, kind: 'text', enter: 'zoom', text: "got it this wrong—|what's a forecast worth?", highlights: ['worth?'], size: 76, media: {src: 'forecast/p_skyline.jpg', type: 'img', effect: 'in'}},
];
...
const SFX: SfxCue[] = [
  ...
  {at: 624, src: 'media/sfx_impact.mp3', vol: 0.5},    // 900K stat
  {at: 1121, src: 'media/sfx_impact.mp3', vol: 0.55},  // 100M stat (the explosion)
  {at: 1444, src: 'media/sfx_chaching.mp3', vol: 0.5}, // $12.6B McCaw buyback
  {at: 1477, src: 'media/sfx_impact.mp3', vol: 0.72},  // red 'A forecast isn't the future.' card
  {at: 1649, src: 'media/sfx_whoosh.mp3', vol: 0.4},   // question close
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>What a forecast is worth</span>
      </div>
...
// ---------------------------------------------------------------------------
export const ForecastReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('forecast/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('forecast/music.mp3')}
