...
// ---------------------------------------------------------------------------
// "What you study" reel (MajorReel) — a myth-bust: two people with the SAME
// degree can end up millions apart in lifetime earnings, because the field of
// study (the major), not the credential, sets the path. "Go to college" is
// treated as the whole decision, but lifetime earnings vary enormously by field
// — a bachelor's in engineering can out-earn the typical master's, while some
// bachelor's paths trail a high-school diploma. The gap between the highest- and
// lowest-paying majors runs into the millions over a career, far wider than the
// gap between degree and no degree — so averaging every major into one "college
// premium" hides the decision that actually moves the number. Question hook
// ("Two people, same degree — millions apart?") with a ~1.2s post-hook pause,
// red `impact` card ("The field. / Not the diploma.") mid-reel, and a question
// close ("Which decision actually mattered?"). Durations on exact ElevenLabs
// spoken-word timestamps at +6% pace; the pause is spliced into the VO right
// after the hook question ("…lifetime earnings?") and beat 1 holds through it
// (71 -> 107). Total 1649 frames = ~55s. **Media-dense:** 18 of 21 beats carry
// footage, with only 2 flat-black beats ("One 'college premium' hides the
// decision.", "What you study is the other half.") plus the one red card. Own
// footage under public/major/ — no asset shared with any other reel (skill hard
// rule). **Unverified claims — verify before publishing:** "same degree,
// millions apart," "engineering bachelor's can out-earn the typical master's,"
// "some bachelor's paths trail a high-school diploma," and "the highest-vs-
// lowest major gap runs into the millions, wider than degree vs no degree" track
// widely-cited lifetime-earnings-by-major research (Georgetown CEW-style) but are
// directional — sanity-check the specifics before publishing.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 82, kind: 'hook', text: 'Two people.|Same degree.', kicker: 'What you study', highlights: ['degree'], size: 88, media: {src: 'major/p_grads.jpg', type: 'img', effect: 'in'}},
  // 71 -> 107: a 36-frame (~1.2s) pause is spliced into the VO right after the
  // hook question ("…lifetime earnings?"), and this beat holds through it.
  {dur: 107, kind: 'text', text: 'Millions|apart?', highlights: ['apart?'], size: 100, media: {src: 'major/p_gap.jpg', type: 'img', effect: 'in'}},
  {dur: 51, kind: 'text', text: 'It\'s rarely|the diploma.', highlights: ['rarely'], size: 84, media: {src: 'major/p_diploma.jpg', type: 'img', effect: 'in'}},
  {dur: 44, kind: 'text', text: 'It\'s the subject|printed on it.', highlights: ['subject'], size: 80, media: {src: 'major/p_books.jpg', type: 'img', effect: 'in'}},
  {dur: 75, kind: 'text', enter: 'slideL', text: '‘Go to college’|the whole decision.', highlights: ['whole'], size: 78, media: {src: 'major/v_campus.mp4', type: 'video', effect: 'in'}},
  {dur: 102, kind: 'text', text: 'Any degree|pays the same.', highlights: ['same'], size: 84, media: {src: 'major/p_paychecks.jpg', type: 'img', effect: 'in'}},
  {dur: 56, kind: 'text', text: 'The credential feels|like the finish line.', highlights: ['finish'], size: 76, media: {src: 'major/p_finishline.jpg', type: 'img', effect: 'in'}},
  {dur: 76, kind: 'text', text: 'Earnings vary|enormously by field.', highlights: ['field'], size: 78, media: {src: 'major/p_lab.jpg', type: 'img', effect: 'in'}},
  {dur: 84, kind: 'text', enter: 'slideL', text: 'Engineering can out-earn|a master’s.', highlights: ['engineering'], size: 74, media: {src: 'major/p_engineer.jpg', type: 'img', effect: 'in'}},
  {dur: 83, kind: 'text', text: 'Some paths trail|high school.', highlights: ['trail'], size: 82, media: {src: 'major/p_tradework.jpg', type: 'img', effect: 'in'}},
  {dur: 88, kind: 'impact', text: 'The field.|Not the diploma.', redBg: true},
  {dur: 111, kind: 'text', text: 'The spread is bigger|than you think.', highlights: ['spread'], size: 80, media: {src: 'major/p_ruler.jpg', type: 'img', effect: 'in'}},
  {dur: 68, kind: 'text', enter: 'slideL', text: 'Highest vs lowest|majors.', highlights: ['majors'], size: 80, media: {src: 'major/v_lecture.mp4', type: 'video', effect: 'in'}},
  {dur: 57, kind: 'text', text: 'Into the|millions.', highlights: ['millions'], size: 96, media: {src: 'major/p_millions.jpg', type: 'img', effect: 'in'}},
  {dur: 107, kind: 'text', text: 'Wider than degree|vs no degree.', highlights: ['wider'], size: 76, media: {src: 'major/p_ladders.jpg', type: 'img', effect: 'in'}},
  {dur: 108, kind: 'text', text: 'One ‘college premium’|hides the decision.', highlights: ['hides'], size: 74},
  {dur: 95, kind: 'text', text: 'The credential matters|less than what it’s in.', highlights: ['less'], size: 74, media: {src: 'major/p_study.jpg', type: 'img', effect: 'in'}},
  {dur: 31, kind: 'text', text: '‘Go to college’|is half the advice.', highlights: ['half'], size: 76, media: {src: 'major/p_signpost.jpg', type: 'img', effect: 'in'}},
  {dur: 57, kind: 'text', text: 'What you study|is the other half.', highlights: ['study'], size: 78},
  {dur: 111, kind: 'text', enter: 'zoom', text: 'And it’s the|bigger half.', highlights: ['bigger'], size: 88, media: {src: 'major/p_halves.jpg', type: 'img', effect: 'in'}},
  {dur: 56, kind: 'text', enter: 'zoom', text: 'Which decision|actually mattered?', highlights: ['mattered?'], size: 78, media: {src: 'major/v_crossroads.mp4', type: 'video', effect: 'in'}},
];
...
// 189), so every cue below is already on the post-pause timeline.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 189, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 461, src: 'media/sfx_impact.mp3', vol: 0.45},
  {at: 760, src: 'media/sfx_impact.mp3', vol: 0.6},
  {at: 959, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 1191, src: 'media/sfx_impact.mp3', vol: 0.45},
  {at: 1425, src: 'media/sfx_whoosh.mp3', vol: 0.42},
  {at: 1593, src: 'media/sfx_whoosh.mp3', vol: 0.4},
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>What you study</span>
      </div>
...
// ---------------------------------------------------------------------------
export const MajorReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('major/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('major/music.mp3')}
