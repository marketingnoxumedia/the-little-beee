...
// ---------------------------------------------------------------------------
// "The strength trap" reel — BlackBerry owned the business phone, dismissed the
// touchscreen, and doubled down on the keyboard until touch and apps became the
// whole market; number one to a rounding error. Durations placed on exact
// spoken-word timestamps (ElevenLabs alignment) at +6% pace. Total 1588 frames
// = ~52.9s. `enter` adds a transition on some cuts. Every scene uses a distinct
// background sourced fresh for this reel — no footage is shared with any other
// reel (see the skill's hard rule). Opens on a suited exec, hero shot of the
// BlackBerry device, a red "your strength is the trap" card in the tail, and
// closes on a physical keyboard ("the whole way down") rather than the red card.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 62, kind: 'hook', text: 'One company owned|the business phone.', kicker: 'The strength trap', highlights: ['owned'], size: 74, media: {src: 'blackberry/v_exec.mp4', type: 'video', effect: 'in'}},
  {dur: 90, kind: 'text', text: 'Every exec|carried its device.', highlights: ['every'], size: 88, media: {src: 'blackberry/p_exec1.jpg', type: 'img', effect: 'in'}},
  {dur: 68, kind: 'text', enter: 'slideR', text: 'Then the iPhone|arrived.', highlights: ['iphone'], size: 92, media: {src: 'blackberry/v_touch.mp4', type: 'video', effect: 'in'}},
  {dur: 40, kind: 'text', text: 'Called it|a fad.', highlights: ['fad'], size: 100, media: {src: 'blackberry/p_touch1.jpg', type: 'img', effect: 'in'}},
  {dur: 59, kind: 'text', text: 'Serious pros|would never want it.', highlights: ['never'], size: 82, media: {src: 'blackberry/p_pro.jpg', type: 'img', effect: 'in'}},
  {dur: 66, kind: 'text', enter: 'slideL', text: 'It was|BlackBerry.', highlights: ['blackberry'], size: 100, media: {src: 'blackberry/p_blackberry.jpg', type: 'img', effect: 'in'}},
  {dur: 46, kind: 'text', text: 'It dominated|business phones.', highlights: ['dominated'], size: 86, media: {src: 'blackberry/p_office.jpg', type: 'img', effect: 'in'}},
  {dur: 103, kind: 'text', enter: 'slideL', text: 'A keyboard.|Secure email.|The whole advantage.', highlights: ['advantage'], size: 72, media: {src: 'blackberry/p_secure.jpg', type: 'img', effect: 'in'}},
  {dur: 49, kind: 'text', text: 'And the whole|trap.', highlights: ['trap'], size: 104},
  {dur: 102, kind: 'text', text: 'Doubling down —|discipline, not denial.', highlights: ['discipline'], size: 74, media: {src: 'blackberry/p_boardroom.jpg', type: 'img', effect: 'in'}},
  {dur: 100, kind: 'text', enter: 'slideL', text: 'Exactly why|enterprises standardised.', highlights: ['enterprises'], size: 76, media: {src: 'blackberry/v_office.mp4', type: 'video', effect: 'in'}},
  {dur: 78, kind: 'text', text: 'Customers said|they wanted them.', highlights: ['wanted'], size: 86, media: {src: 'blackberry/p_keyboard1.jpg', type: 'img', effect: 'in'}},
  {dur: 80, kind: 'text', text: 'Chasing all-touchscreen|meant leaving.', highlights: ['leaving'], size: 78, media: {src: 'blackberry/p_touch2.jpg', type: 'img', effect: 'in'}},
  {dur: 80, kind: 'text', enter: 'slideR', text: 'The buyers|who actually paid.', highlights: ['paid'], size: 86, media: {src: 'blackberry/p_handshake.jpg', type: 'img', effect: 'in'}},
  {dur: 74, kind: 'text', text: 'Until those buyers|changed their minds.', highlights: ['changed'], size: 80, media: {src: 'blackberry/v_crowd.mp4', type: 'video', effect: 'in'}},
  {dur: 55, kind: 'text', text: 'Touchscreens and apps|became the market.', highlights: ['market'], size: 78, media: {src: 'blackberry/v_apps.mp4', type: 'video', effect: 'in'}},
  {dur: 77, kind: 'text', enter: 'slideL', text: 'The differentiator|turned into ballast.', highlights: ['ballast'], size: 78, media: {src: 'blackberry/p_anchor.jpg', type: 'img', effect: 'in'}},
  {dur: 54, kind: 'text', text: 'From number one|to a rounding error.', highlights: ['rounding'], size: 78, media: {src: 'blackberry/p_lonephone.jpg', type: 'img', effect: 'in'}},
  {dur: 40, kind: 'text', text: 'It once defined|the smartphone.', highlights: ['defined'], size: 84, media: {src: 'blackberry/p_oldphones.jpg', type: 'img', effect: 'in'}},
  {dur: 48, kind: 'text', enter: 'zoom', text: 'Then vanished|in a few years.', highlights: ['vanished'], size: 84, media: {src: 'blackberry/p_recycle.jpg', type: 'img', effect: 'in'}},
  {dur: 43, kind: 'impact', text: 'Your strength|is the trap.', redBg: true},
  {dur: 39, kind: 'text', text: 'The hardest feature|to drop —', highlights: ['hardest'], size: 82, media: {src: 'blackberry/p_ipaq.jpg', type: 'img', effect: 'in'}},
  {dur: 47, kind: 'text', text: 'is the one|that made you.', highlights: ['made'], size: 90, media: {src: 'blackberry/p_close.jpg', type: 'img', effect: 'in'}},
  {dur: 31, kind: 'text', text: 'Number one,|to almost zero.', highlights: ['zero'], size: 88, media: {src: 'blackberry/p_dark.jpg', type: 'img', effect: 'in'}},
  {dur: 57, kind: 'text', enter: 'slideUp', text: 'Held the keyboard|the whole way down.', highlights: ['keyboard'], size: 80, media: {src: 'blackberry/p_made.jpg', type: 'img', effect: 'in'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 62, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 319, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 534, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 1023, src: 'media/sfx_whoosh.mp3', vol: 0.45},
  {at: 1097, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 1152, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 1323, src: 'media/sfx_impact.mp3', vol: 0.72},
  {at: 1531, src: 'media/sfx_impact.mp3', vol: 0.5},
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>The strength trap</span>
      </div>
...
// ---------------------------------------------------------------------------
export const BlackberryReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('blackberry/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('blackberry/music.mp3')}
