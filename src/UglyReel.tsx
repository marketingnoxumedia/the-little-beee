...
// ---------------------------------------------------------------------------
// "Nobody will touch it" reel (UglyReel) — portable sanitation as a moat business, told as the
// A/B twin of the existing SanitationReel ("The disgust moat"). One of the most defensible small
// businesses is one almost nobody will start: renting and servicing portable toilets for
// construction sites and events on recurring contracts. The moat is other people's reluctance —
// the work is unpleasant enough that competitors don't rush in, so pricing stays rational with no
// brand or technology edge; the servicing recurs because units are cleaned on a schedule, and the
// contracts renew whether anyone thinks about them or not. Construction and events guarantee
// demand, and the unpleasantness itself is the barrier keeping rivals out. Low competition plus
// recurring servicing is a quietly strong model — margins vary too much by route to quote an
// honest figure, so no number is asserted. The lesson: a reputation for gross is a kind of
// protection; what makes people avoid a business defends the ones already in it. Where
// SanitationReel opens and closes declaratively, this take opens on a question ("...one almost
// nobody will start?") and closes on one ("who's really winning — the pretty business, or the one
// nobody will touch?"), with entirely its own fresh footage under public/ugly/ — no asset shared
// with SanitationReel or any other reel. A short ~1.5s pause after the hook (house convention),
// black beats for the punch-lines, one red "Gross is protection." `impact` card as the mid-tail
// thesis, and the question close on footage rather than the red card. Durations sit on exact
// ElevenLabs spoken-word timestamps at +6% pace; music is normalized and mixed at 0.17. Total
// 1687 frames = ~56.2s. Footage was screened for legible brand marks: several construction/
// equipment clips were rejected for visible logos (excavator/tool brands, ad billboards, event
// ad-flags) and dropped to black beats or re-sourced. The one unavoidable exception is the small
// rental-company wordmark moulded on the portable-toilet unit in the reveal still (porta-potties
// always carry one); it is minor and incidental to the subject. The "quietly strong model" claim
// is deliberately un-numbered because operator margins genuinely vary by route.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 119, kind: 'hook', text: 'One of the most|defensible businesses—', kicker: 'Nobody will touch it', highlights: ['defensible'], size: 78, media: {src: 'ugly/v_hook.mp4', type: 'video', effect: 'in'}},
  // Short ~1.5s pause after the hook (house convention): 45 frames of silence are spliced into
  // the VO right after "...nobody will start?", and this beat holds through it (33 -> 78).
  {dur: 78, kind: 'text', text: 'and almost nobody|will start it?', highlights: ['nobody'], size: 84},
  {dur: 33, kind: 'text', text: 'The thing that|makes people—', highlights: ['thing'], size: 84},
  {dur: 50, kind: 'text', text: 'refuse to|run it—', highlights: ['refuse'], size: 90},
  {dur: 32, kind: 'text', text: 'is exactly what|protects it.', highlights: ['protects'], size: 84},
  {dur: 58, kind: 'text', enter: 'slideL', text: "It's portable|sanitation.", highlights: ['sanitation'], size: 90, media: {src: 'ugly/p_row.jpg', type: 'img', effect: 'in'}},
  {dur: 46, kind: 'text', text: 'Rent and service|the units.', highlights: ['service'], size: 88, media: {src: 'ugly/v_units.mp4', type: 'video', effect: 'in'}},
  {dur: 52, kind: 'text', text: 'Construction sites.|And events.', highlights: ['construction'], size: 84},
  {dur: 78, kind: 'text', enter: 'slideL', text: 'On recurring|contracts.', highlights: ['recurring'], size: 90, media: {src: 'ugly/p_contract.jpg', type: 'img', effect: 'in'}},
  {dur: 38, kind: 'text', text: 'The moat is|their reluctance.', highlights: ['reluctance'], size: 82},
  {dur: 54, kind: 'text', text: 'The work is|unpleasant enough—', highlights: ['unpleasant'], size: 82, media: {src: 'ugly/p_gloves.jpg', type: 'img', effect: 'in'}},
  {dur: 38, kind: 'text', text: "rivals don't|rush in.", highlights: ['rivals'], size: 90},
  {dur: 61, kind: 'text', text: 'So pricing|stays rational.', highlights: ['rational'], size: 88},
  {dur: 38, kind: 'text', text: 'No brand.|No tech edge.', highlights: ['brand'], size: 94},
  {dur: 64, kind: 'text', text: 'The servicing|recurs.', highlights: ['recurs'], size: 92, media: {src: 'ugly/v_service.mp4', type: 'video', effect: 'in'}},
  {dur: 29, kind: 'text', text: 'Cleaned|on a schedule.', highlights: ['schedule'], size: 90, media: {src: 'ugly/p_calendar.jpg', type: 'img', effect: 'in'}},
  {dur: 114, kind: 'text', text: 'Contracts renew|whether you notice|or not.', highlights: ['renew'], size: 76},
  {dur: 82, kind: 'text', text: 'Construction, events—|steady demand.', highlights: ['demand'], size: 80, media: {src: 'ugly/v_event.mp4', type: 'video', effect: 'in'}},
  {dur: 52, kind: 'text', enter: 'slideL', text: 'The unpleasantness|is the barrier.', highlights: ['barrier'], size: 82},
  {dur: 77, kind: 'text', text: 'Low competition.|Recurring service.', highlights: ['low'], size: 82},
  {dur: 110, kind: 'text', text: 'A quietly|strong model.', highlights: ['strong'], size: 90, media: {src: 'ugly/p_event.jpg', type: 'img', effect: 'in'}},
  {dur: 28, kind: 'text', text: 'Margins vary|too much to quote.', highlights: ['margins'], size: 82},
  {dur: 45, kind: 'text', text: 'A reputation|for gross—', highlights: ['gross'], size: 88},
  {dur: 44, kind: 'impact', text: 'Gross is|protection.', redBg: true},
  {dur: 62, kind: 'text', enter: 'slideL', text: 'What makes people|avoid it—', highlights: ['avoid'], size: 82},
  {dur: 37, kind: 'text', text: 'defends the ones|already in it.', highlights: ['defends'], size: 84},
  {dur: 69, kind: 'text', enter: 'slideL', text: 'If the ugliest work|scares off rivals—', highlights: ['ugliest'], size: 78, media: {src: 'ugly/v_dusk.mp4', type: 'video', effect: 'in'}},
  {dur: 63, kind: 'text', text: "who's really|winning?", highlights: ['winning?'], size: 92},
  {dur: 36, kind: 'text', enter: 'zoom', text: 'Or the one|nobody will touch?', highlights: ['nobody'], size: 84, media: {src: 'ugly/p_potty.jpg', type: 'img', effect: 'in'}},
];
...
const SFX: SfxCue[] = [
  {at: 197, src: 'media/sfx_whoosh.mp3', vol: 0.4},   // reveal after the pause
  {at: 312, src: 'media/sfx_whoosh.mp3', vol: 0.35},  // subject reveal ('portable sanitation')
  {at: 638, src: 'media/sfx_impact.mp3', vol: 0.5},   // 'rivals don't rush in' (the barrier)
  {at: 775, src: 'media/sfx_impact.mp3', vol: 0.45},  // 'the servicing recurs'
  {at: 1376, src: 'media/sfx_impact.mp3', vol: 0.72}, // red 'Gross is protection.' card
  {at: 1651, src: 'media/sfx_whoosh.mp3', vol: 0.4},  // question close
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>Nobody will touch it</span>
      </div>
...
// ---------------------------------------------------------------------------
export const UglyReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('ugly/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('ugly/music.mp3')}
